...
class TeachingstaffannualincrementforboardController extends Controller
{
    /**
...
//   $data[$staffId]['agp']); 
    ...
    //dd($data['31']['total']);
         ...
         return view('ESTB.salaries.GenerateAnnualIncrement.Board.Teaching.index',compact(['staff','data']));
    }
