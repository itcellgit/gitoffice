...
use App\Models\HOD\internship\student_studentinternship;
...
class hod_StudentStudentinternshipController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('HOD.internship.showinternship',compact('students','studentinternship','student_internships','studentsWithoutInternship'));
     ...
     public function store(Storestudent_studentinternshipRequest $request, studentinternship $studentinternship)
    {
        ...
        return redirect('/HOD/internship/studentinternship/'.$studentinternship->id.'/show');
    }
    ...
    public function show(student_studentinternship $student_studentinternship)
    {
        ...
        return view('HOD.internship.showinternship',compact(['studentinternship','students','student_studentinternship']));
    }
