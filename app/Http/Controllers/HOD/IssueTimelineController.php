...
class IssueTimelineController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('HOD.issue_timeline', compact('student_issues', 'staff', 'examSectionIssues'));
    }
    ...
    public function store(Storeissue_timelineRequest $request,student_issue $student_issue)
    {
       ...
       // dd($user->id);
        ...
        return redirect('/HOD/viewstudentissues/'.$student_issue->id.'/show');
    }
    ...
    public function show(issue_timeline $issue_timeline,$student_issue)
    {
        ...
        // dd($student_issue);
        return view('/HOD/viewstudentissues/'.$student_issue->id.'/show', compact('student_issue'));
    }
