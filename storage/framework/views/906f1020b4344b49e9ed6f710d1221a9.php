                                                        ...
                                                        <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 md:mx-auto">
                                                            <div class="ti-modal-content">
                                                                <div class="ti-modal-header">
                                                                    ...
                                                                    <?php if(($errors->has('ga_award'))||($errors->has('ga_year'))||($errors->has('ga_details'))||($errors->has('document'))||($errors->has('ga_awarding_body'))): ?>
                                                                        <script>
                                                                            //alert(1);
                                                            ...
                                                            <tbody class="">
                                                                ...
                                                                <?php if($staff->general_achievements!=null): ?>
                                                                    ...
                                                                    <?php $__empty_1 = true; $__currentLoopData = $staff->general_achievements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $achivement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                                            <tr style="<?php if($achivement->validation_status =='invalid'): ?> background-color: #ffcccc; <?php elseif($achivement->validation_status =='updated'): ?> background-color: #fff2cc; <?php elseif($achivement->validation_status =='valid'): ?> background-color: #ccffcc; <?php endif; ?>">
                                                                            ...
                                                                            <td><span><?php echo e($achivement->awarding_body); ?></span></td>
                                                                            <?php if(!isset($export) || !$export): ?>
                                                                            <td class="font-medium space-x-2 rtl:space-x-reverse">
                                                                                            ...
                                                                                            <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 md:mx-auto">
                                                                                                <div class="ti-modal-content">
                                                                                                    ...
                                                                                                    <div class="ti-modal-body">
                                                                                                        ...
                                                                                                        <div><?php echo e($achivement->reason); ?></div>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                ...
                                                                                <div class="hs-tooltip ti-main-tooltip">
                                                                                    <a  href="<?php echo e(Storage::url('Uploads/Research/Achievement/' . $achivement->document)); ?>" class="m-0 hs-tooltip-toggle relative w-8 h-8 ti-btn rounded-full p-0 transition-none focus:outline-none ti-btn-soft-primary" target="_blank" <?php echo e($achivement->document); ?>>
                                                                                                ...
                                                                                                <div class="ti-modal-header">
                                                                                                    ...
                                                                                                    <button type="button" class="hs-dropdown-toggle ti-modal-close-btn"
                                                                                                        ...
                                                                                                        <svg class="w-3.5 h-3.5" width="8" height="8" viewBox="0 0 8 8" fill="none"
                                                                                                            ...
                                                                                                            <?php if(($errors->has('gae_award'))||($errors->has('gae_year'))||($errors->has('gae_details'))||($errors->has('gae_awarding_body'))): ?>
                                                                                                            <script>
                                                                                                            //alert(387);
                                                                                                ...
                                                                                                <form  action="<?php echo e(route('Teaching.research.achievement.update',$achivement->id)); ?>" method="post" enctype="multipart/form-data">
                                                                                                    ...
                                                                                                    <input type='hidden' name='achievements_modal_no' class='achievements_modal_no' value=<?php echo e(old('achievements_modal_no')); ?>/>
                                                                                                        ...
                                                                                                        <div class="grid lg:grid-cols-2 gap-2 space-y-2 lg:space-y-0">
                                                                                                            ...
                                                                                                            <div class="max-w-sm space-y-3 pb-6">
                                                                                                                <label for="" class="ti-form-label font-bold">Awarding Body:<span class="text-red-500">*</span></label>
                                                                                                                <input type="text" name="gae_awarding_body" class="ti-form-input" required placeholder="Awarding Body" value="<?php echo e($achivement->awarding_body); ?>">
                                                                                                                <?php if($errors->has('awarding_body')): ?>
                                                                                                                    <div class="text-red-700"><?php echo e($errors->first('awarding_body')); ?></div>
                                                                                                                <?php endif; ?>
                                                                                                                <div id="awarding_bodyError" class="error text-red-700"></div>
