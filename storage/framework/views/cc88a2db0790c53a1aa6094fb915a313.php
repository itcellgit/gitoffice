                                                        ...
                                                        <?php if(!isset($export) || !$export): ?>
                                                            <td>
                                                                <div class="hs-tooltip ti-main-tooltip">
                                                                    <a  href="<?php echo e(Storage::url('Uploads/Research/Conference_Conducted/' .$conducted->document)); ?>" class="m-0 hs-tooltip-toggle relative w-8 h-8 ti-btn rounded-full p-0 transition-none focus:outline-none ti-btn-soft-primary" target="_blank" <?php echo e($conducted->document); ?>>
                                                                    ...
                                                                    <div id="validate_edit_modal<?php echo e($i); ?>" class="hs-overlay hidden ti-modal">
                                                                        <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 md:mx-auto">
                                                                            <div class="ti-modal-content">
                                                                                ...
                                                                                <form action="<?php echo e(route('egov.Teaching.research.conferenceconducted.update', $conducted->id)); ?>" method="post">
                                                                                    <?php echo csrf_field(); ?>
