                                                                            ...
                                                                            <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                                                                ...
                                                                                <form  action="<?php echo e(route('ticket.update',$ticket->id)); ?>" method="post" enctype="multipart/form-data"> 
                                                                                    ...
                                                                                    <div class="ti-modal-body">
                                                                                        ...
                                                                                        <div class="max-w-sm space-y-3 pb-6">
                                                                                            <label for="" class="ti-form-label">Description:</label>
                                                                                            <textarea name="description" class="ti-form-input" required placeholder="Description" style="width: 100%; height: 150px;" value="<?php echo e($ticket->description); ?>"></textarea>
                                                                                        </div>
