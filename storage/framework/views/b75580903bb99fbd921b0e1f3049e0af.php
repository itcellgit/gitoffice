                    ...
                    <table id="postticket_table" class="ti-custom-table ti-custom-table-head whitespace-nowrap">
                        ...
                        <tbody class="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <span>
                                        <img src="<?php echo e(asset('attachment/'.$pt->attachment)); ?>" style="max-width: 100px; max-height: 100px; cursor: pointer;" onclick="showLargeImage('<?php echo e(asset('attachment/'.$pt->attachment)); ?>')" >
                                    </span>
                                </td>
