                        ...
                        <div class="box-body">
                                ...
                                <div class="flex w-full pb-8">
                                    <div class="ltr:ml-5 rtl:mr-5 rounded-sm ltr:mr-auto rtl:ml-auto my-auto w-full space-y-3">
                                        ...
                                        <div class="flex flex-col rtl:flex-row -space-y-2 rtl:space-x-reverse" style="margin-top: 10px;">
                                            ...
                                            <img src="<?php echo e(asset('attachment/'.$ticket->attachment)); ?>" alt="NoImage" onclick="showLargeImage('<?php echo e(asset('attachment/'.$ticket->attachment)); ?>')" style="width: 50px; height: 50px;">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="flex flex-row">
                                ...
                                <div class="flex w-full pb-8">
                                    <div class="ltr:ml-5 rtl:mr-5 rounded-sm ltr:mr-auto rtl:ml-auto my-auto w-full space-y-3">
                                        <div class="sm:flex">
                                            <h3 class="my-auto text-gray-500 dark:text-white/70"><span class="text-dark dark:text-white">My Issue: <?php echo e($pt->title); ?></span></h3>
                                            <p class="my-auto ltr:ml-auto rtl:mr-auto text-gray-500 dark:text-white/70 text-xs">
                                                <?php echo e($pt->created_at); ?>
