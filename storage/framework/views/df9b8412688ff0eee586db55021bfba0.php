                        ...
                        <!-- Page Header -->
                            <div class="justify-between block page-header sm:flex">
                                <div>
                                    ...
                                    <h3 class="text-2xl font-medium text-gray-700 hover:text-gray-900 dark:text-white dark:hover:text-white">Welcome<span class="text-primary"> <?php echo e($staff->fname.' '.$staff->mname.' '.$staff->lname); ?></span></h3>
                                </div>
                                                                        ...
                                                                        <td class="space-x-2 font-medium rtl:space-x-reverse">
                                                                            ...
                                                                            <?php if ($act->validation_status === 'invalid'): ?>
                                                                                <div class="text-center hs-tooltip ti-main-tooltip">
                                                                                    ...
                                                                                    <div id="reason_view_modal<?php echo e($i); ?>" class="hidden hs-overlay ti-modal">
                                                                                        <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 md:mx-auto">
                                                                                            <div class="ti-modal-content">
                                                                                                <div class="ti-modal-header">
                                                                                                    <h3 class="ti-modal-title">
                                                                            ...
                                                                            <div class="hs-tooltip ti-main-tooltip">
                                                                                <a href="<?php echo e(Storage::url('Uploads/Professional_Activity_Attended/'.$act->document)); ?>" class="relative w-8 h-8 p-0 m-0 transition-none rounded-full hs-tooltip-toggle ti-btn focus:outline-none ti-btn-soft-primary" target="_blank" <?php echo e($act->document); ?>>
                                                                            ...
                                                                            <div class="hs-tooltip ti-main-tooltip">
                                                                                ...
                                                                                <div id="professional_activity_edit_modal<?php echo e($i); ?>" class="hidden hs-overlay ti-modal">
                                                                                    <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 md:mx-auto">
                                                                                        <div class="ti-modal-content">
                                                                                            <div class="ti-modal-header">
                                                                                                <h3 class="ti-modal-title">
                                                                                            ...
                                                                                            <form  action="<?php echo e(route('Teaching.professionalactivities.attended.update',$act->id)); ?>" method="post" enctype="multipart/form-data">
                                                                                                ...
                                                                                                <div class="ti-modal-body">
                                                                                                    ...
                                                                                                    <div class="grid gap-1 space-y-2 lg:grid-cols-2 lg:space-y-0">
                                                                                                        ...
                                                                                                        <div class="max-w-sm pb-6 space-y-3">
                                                                                                            <div class="max-w-sm pb-6 space-y-3">
                                                                                                                <label for="" class="pt-4 font-bold ti-form-label">Document:<span class="text-red-500">*<?php echo e($act->document); ?></span></label>
                                                                                                                <span class="sr-only">Choose Profile photo</span>
                                                                                                                    <input type="file" accept="application/pdf" name="document" class="block w-full text-sm text-gray-500 dark:text-white/70 focus:outline-0 ltr:file:mr-4 rtl:file:ml-4 file:py-2 file:px-4 file:rounded-sm file:border-0 file:text-sm file:font-semibold file:bg-primary file:text-white hover:file:bg-primary focus-visible:outline-none doc" required value="<?php echo e($act->document); ?>">
                                                                                                                    <?php if($errors->has('document')): ?>
                                                                                                                        <div class="text-red-700"><?php echo e($errors->first('document')); ?></div>
                                                                                                                    <?php endif; ?>
                                                                ...
                                                                <?php $__empty_1 = true; $__currentLoopData = $staff->professional_activity_conducted; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $conduct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                                    <tr style="<?php if($conduct->validation_status =='invalid'): ?> background-color: #ffcccc; <?php elseif($conduct->validation_status =='updated'): ?> background-color: #fff2cc; <?php elseif($conduct->validation_status =='valid'): ?> background-color: #ccffcc; <?php endif; ?>">
                                                                        ...
                                                                        <td class="space-x-2 font-medium rtl:space-x-reverse">
                                                                            ...
                                                                            <!--Modal Ends Here-->
                                                                            <div class="hs-tooltip ti-main-tooltip">
                                                                                <a  href="<?php echo e(Storage::url('Uploads/Professional_Activity_Conducted/' . $conduct->document)); ?>" class="relative w-8 h-8 p-0 m-0 transition-none rounded-full hs-tooltip-toggle ti-btn focus:outline-none ti-btn-soft-primary" target="_blank" <?php echo e($conduct->document); ?>>
                                                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16"><path d="M12.0003 3C17.3924 3 21.8784 6.87976 22.8189 12C21.8784 17.1202 17.3924 21 12.0003 21C6.60812 21 2.12215 17.1202 1.18164 12C2.12215 6.87976 6.60812 3 12.0003 3ZM12.0003 19C16.2359 19 19.8603 16.052 20.7777 12C19.8603 7.94803 16.2359 5 12.0003 5C7.7646 5 4.14022 7.94803 3.22278 12C4.14022 16.052 7.7646 19 12.0003 19ZM12.0003 16.5C9.51498 16.5 7.50026 14.4853 7.50026 12C7.50026 9.51472 9.51498 7.5 12.0003 7.5C14.4855 7.5 16.5003 9.51472 16.5003 12C16.5003 14.4853 14.4855 16.5 12.0003 16.5ZM12.0003 14.5C13.381 14.5 14.5003 13.3807 14.5003 12C14.5003 10.6193 13.381 9.5 12.0003 9.5C10.6196 9.5 9.50026 10.6193 9.50026 12C9.50026 13.3807 10.6196 14.5 12.0003 14.5Z"></path></svg>
                                                                                    <span class="px-2 py-1 text-xs font-medium text-white bg-gray-900 shadow-sm hs-tooltip-content ti-main-tooltip-content" role="tooltip">
                                                                                    View Document
                                                                                    </span>
                                                                            ...
                                                                            <div class="hs-tooltip ti-main-tooltip">
                                                                                ...
                                                                                <div id="_edit_modal<?php echo e($i); ?>" class="hidden hs-overlay ti-modal">
                                                                                    <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 md:mx-auto">
                                                                                        <div class="ti-modal-content">
                                                                                            <div class="ti-modal-header">
                                                                                                <h3 class="ti-modal-title">
                                                                                            ...
                                                                                            <form  action="<?php echo e(route('Teaching.professionalactivities.conducted.update',$conduct->id)); ?>" enctype="multipart/form-data" method="post">
                                                                                                ...
                                                                                                <div class="ti-modal-body">
                                                                                                    ...
                                                                                                    <div class="grid gap-1 space-y-2 lg:grid-cols-2 lg:space-y-0">
                                                                                                        ...
                                                                                                        <div class="max-w-sm pb-6 space-y-3">
                                                                                                            <div class="max-w-sm pb-6 space-y-3">
                                                                                                                <label for="" class="pt-4 font-bold ti-form-label">Document:<span class="text-red-500">* <?php echo e($conduct->document); ?></span></label>
                                                                                                                <span class="sr-only">Choose Profile photo</span>
                                                                                                                    <input type="file" accept="application/pdf" name="document" class="block w-full text-sm text-gray-500 dark:text-white/70 focus:outline-0 ltr:file:mr-4 rtl:file:ml-4 file:py-2 file:px-4 file:rounded-sm file:border-0 file:text-sm file:font-semibold file:bg-primary file:text-white hover:file:bg-primary focus-visible:outline-none doc" required value="<?php echo e($conduct->document); ?>">
                                                                                                                    <?php if($errors->has('document')): ?>
                                                                                                                        <div class="text-red-700"><?php echo e($errors->first('document')); ?></div>
                                                                                                                    <?php endif; ?>
                                                                                                                <div id="docEditError" class="text-red-700 error"></div>
