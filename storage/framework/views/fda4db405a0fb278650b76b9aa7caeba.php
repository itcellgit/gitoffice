                                        ...
                                        <table id="book_chapter_table" class="ti-custom-table ti-custom-table-head whitespace-nowrap">
                                            ...
                                            <tbody class="">
                                                <?php $__currentLoopData = $books_chapters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <tr style="<?php if($book->validation_status =='invalid'): ?> background-color: #ffcccc; <?php elseif($book->validation_status =='updated'): ?> background-color: #fff2cc; <?php elseif($book->validation_status =='valid'): ?> background-color: #ccffcc; <?php endif; ?>">
                                                                    ...
                                                                    <div id="validate_edit_modal<?php echo e($i); ?>" class="hs-overlay hidden ti-modal">
                                                                        <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 md:mx-auto">
                                                                            <div class="ti-modal-content">
                                                                                ...
                                                                                <form action="<?php echo e(route('egov.Teaching.research.book_chapter.update', $book->id)); ?>" method="post">
                                                                                    <?php echo csrf_field(); ?>
