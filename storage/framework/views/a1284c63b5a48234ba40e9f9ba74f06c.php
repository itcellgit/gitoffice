                        ...
                        $.ajax({
                                ...
                                success: function(response) {
                                    ...
                                    if(response.length !=0){
                                       ...
                                       if(value.appl_status == 'NULL'){
                                            bg_color_setting = "";
                                       }else if(value.appl_status == "recommended"){
                                            bg_color_setting = "bg-amber-300";
                                       }else if(value.appl_status == "rejected"){
                                            bg_color_setting = "bg-red-300";
                                       }else if(value.appl_status == "approved"){
                                            bg_color_setting = "bg-green-300";
                                       }
                                        $('#Date_wise_leave__list').append('<tr class='+bg_color_setting+'>'
                                                                    ...
                                                                    +'<td>'
                                                                        ...
                                                                        +'<div class="hs-tooltip ti-main-tooltip">'
                                                                                                    ...
                                                                                                    +'<button data-hs-overlay="#recommend_leave'+value.Application_id+'" class="hs-dropdown-toggle ti-btn ti-btn-primary"'
                                                                                                    +' class="hs-dropdown-toggle  m-0 hs-tooltip-toggle relative w-8 h-8 ti-btn rounded-full p-0 transition-none focus:outline-none ti-btn-soft-secondary">'
                                                                                                        ...
                                                                                                        +'</span>'
                                                                                                    +'</button>'
                                                                                                        +'<div style="z-index:9999" id="recommend_leave'+value.Application_id+'" class="hs-overlay hidden ti-modal">'
                                                                                                            +'<div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 md:mx-auto">'
                                                                                                                +'<div class="ti-modal-content">'
                                                                                                                    +'<div class="ti-modal-header">'
                                                                                                                        +'<h3 class="ti-modal-title">'
                                                                                                                            +'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16" fill="currentColor"><path d="M11 6V14H19C19 18.4183 15.4183 22 11 22C6.58172 22 3 18.4183 3 14C3 9.66509 6.58 6 11 6ZM21 2V4L15.6726 10H21V12H13V10L18.3256 4H13V2H21Z"></path></svg>'
                                                                                                                            +'Recommend Leave <span id="leave_date" class="text-primary font-bold"></span>'
                                                                                                                        +'</h3>'
                                                                                                                            +'<button type="button" class="hs-dropdown-toggle ti-modal-close-btn"'
                                                                                                                              +' data-hs-overlay="#recommend_leave'+value.Application_id+'">'
                                                                                                                                +'<span class="sr-only">Close</span>'
                                                                                                                                +'<svg class="w-3.5 h-3.5" width="8" height="8" viewBox="0 0 8 8" fill="none"'
                                                                                                                                   +' xmlns="http://www.w3.org/2000/svg">'
                                                                                                                                    +'<path'
                                                                                                                    ...
                                                                                                                    +'<div class="ti-modal-footer">'
                                                                                                                        ...
                                                                                                                        +'<input type="submit" class="ti-btn  bg-primary text-white hover:bg-warning  focus:ring-primary  dark:focus:ring-offset-white/10" value="Recommend"/>'
