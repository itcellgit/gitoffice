        ...
        <div class="main-content">
            ...
            <div class="box">
                <div class="box-body">
                                                                                            ...
                                                                                            <form
                                                                                                ...
                                                                                                <div class="ti-modal-body">
                                                                                                    ...
                                                                                                    <div class="max-w-sm space-y-3 pb-6">
                                                                                                        ...
                                                                                                        <!-- Display the current file's name if it exists -->
                                                                                                        @if ($timeline->file)
                                                                                                            <a href="{{ route('internship.file.download', $timeline->file) }}">Current File: {{ basename($timeline->file) }}</a>
                                                                                                        @endif
                                                                                                    </div>
                 ...
                 <div>
                    <a href="/Teaching/internship/student" class="ti-btn bg-primary text-white hover:bg-primary focus:ring-primary dark:focus:ring-offset-white/10" >Back</a>
            </div>
