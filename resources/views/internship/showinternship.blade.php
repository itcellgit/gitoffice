    ...
    <div class="content">
        ...
        <div class="main-content">
                                                                ...
                                                                @foreach ($students as $student)
                                                                    <div class="ti-form-checkbox-item">
                                                                        <input type="checkbox" name="student_id[]"
                                                                            ...
                                                                            class="form-checkbox"
                                                                            {{ $studentinternship->student->contains($student) ? 'checked' : '' }}>
            ...
            <div class="container mt-5">
                ...
                <a href="/Teaching/internship/studentinternship" class="ti-btn bg-primary text-white hover:bg-primary focus:ring-primary dark:focus:ring-offset-white/10">Back</a>
            </div>
