                                                ...
                                                <div class="ti-modal-content">
                                                    ...
                                                    <form action="{{ route('internship.student.store') }}" method="post"
                                                        ...
                                                        <div class="ti-modal-body">
                                                            ...
                                                            {{-- <div class="max-w-sm space-y-3 pb-6">
                                                                    <label for="" class="ti-form-label">USN : </label>
                                                                    <input type="text" name="usn" class="ti-form-input" required placeholder="USN">
                                                                </div> --}}
                                                            ...
                                                            {{-- <div class="max-w-sm space-y-3 pb-6">
                                                                <label for="" class="ti-form-label">Batch :
                                                                </label>
                                                                <select  name="batch"
                                                                    class="ti-form-input" required>
                                                                        ...
                                                                        <div class="ti-modal-content">
                                                                            ...
                                                                            <form
                                                                                ...
                                                                                <div class="ti-modal-body">
                                                                                    ...
                                                                                    {{-- <label for="" class="ti-form-label">Batch :</label>
                                                                            <input type="text" name="batch" class="ti-form-input"   value="{{$student->batch}}"> --}}
