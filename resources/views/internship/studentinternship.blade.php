                                    ...
                                    <div id="hs-medium-modal" class="hs-overlay hidden ti-modal">
                                        <div
                                            ...
                                            <div class="ti-modal-content">
                                                ...
                                                <form action="{{ route('internship.studentinternship.store') }}"
                                                    method="post">
                                                    @csrf
                                    ...
                                    @forelse($studentinternships as $studentinternship)
                                        <tr class="">
                                            ...
                                            <td class="font-medium space-x-2 rtl:space-x-reverse">
                                                    ...
                                                    <div id="studentinternships_edit_modal{{ $counter }}"
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="ti-modal-content">
                                                                ...
                                                                <form
                                                                    action="{{ route('internship.studentinternship.update', $studentinternship->id) }}"
                                                                    method="post">
                                                                    @csrf
                                                                    @method('patch')
                                                                    <div class="ti-modal-body">
                                                ...
                                                <div class="hs-tooltip ti-main-tooltip">
                                                    <form
                                                        action="{{ route('internship.studentinternship.destroy', $studentinternship->id) }}"
                                                        method="post">
