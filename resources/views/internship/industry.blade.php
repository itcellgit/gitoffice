                    ...
                    <div class="box">
                        <div class="box-body">
                            <div class="flex">
                                ...
                                <div class="flex-1">
                                    <p class="text-sm font-bold">Total Number of Industries</p>
                                            ...
                                            <div id="hs-medium-modal" class="hs-overlay hidden ti-modal">
                                                <div
                                                    ...
                                                    <div class="ti-modal-content">
                                                        ...
                                                        <form action="{{ route('internship.industry.store') }}"
                                                            method="post">
                                                            @csrf
                                                            <div class="ti-modal-body">
                                                                ...
                                                                <div class="max-w-sm space-y-3 pb-6">
                                                                    <label for="with-corner-hint"
                                                                        class="ti-form-label">Name : </label>
                                                                ...
                                                                <div class="max-w-sm space-y-3 pb-6">
                                                                    <label for="" class="ti-form-label">Location :
                                                                    </label>
                                                                ...
                                                                <div class="max-w-sm space-y-3 pb-6">
                                                                    <label for="" class="ti-form-label">Domain :
                                                                    </label>
                                                                    <select id="domain" name="domain"
                                                                        ...
                                                                        <option value="Database Management">Database
                                                                            Management</option>
                                        ...
                                        <table id="industry_table"
                                            ...
                                            <tbody class="">
                                                ...
                                                @if ($industries != null)
                                                        ...
                                                        <tr class="">
                                                            ...
                                                            <td class="font-medium space-x-2 rtl:space-x-reverse">
                                                                {{-- <div class="hs-tooltip ti-main-tooltip">
                                                                    <a href="{{ route('internship.industry.show', $industry->id) }}"
                                                                ...
                                                                <div class="hs-tooltip ti-main-tooltip">
                                                                    <button
                                                                        data-hs-overlay="#industries_edit_modal{{ $i }}"
                                                                    ...
                                                                    <div id="industries_edit_modal{{ $i }}"
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class="ti-modal-content">
                                                                                ...
                                                                                <form
                                                                                    action="{{ route('internship.industry.update', $industry->id) }}"
                                                                                    method="post">
                                                                                    @csrf
                                                                                    @method('patch')
                                                                                    <div class="ti-modal-body">
                                                                                        ...
                                                                                        <div
                                                                                            class="max-w-sm space-y-3 pb-6">
                                                                                            <label for="domain"
                                                                                                class="ti-form-label">Domain:</label>
                                                                                            <select id="domain"
                                                                                                name="domain"
                                                                                                class="ti-form-input"
                                                                                                >
                                                                                                <option value=""
                                                                                                    disabled>Select Domain
                                                                                                </option>
                                                                                                <option
                                                                                                    value="Web Development"
                                                                                                    {{ $industry->domain == 'Web Development' ? 'selected' : '' }}>
                                                                                                    Web Development</option>
                                                                                                <option
                                                                                                    value="Mobile App Development"
                                                                                                    {{ $industry->domain == 'Mobile App Development' ? 'selected' : '' }}>
                                                                                                    Mobile App Development
                                                                                                </option>
                                                                                                <option
                                                                                                    value="Software Engineering"
                                                                                                    {{ $industry->domain == 'Software Engineering' ? 'selected' : '' }}>
                                                                                                    Software Engineering
                                                                                                </option>
                                                                                                <option
                                                                                                    value="Network Administration"
                                                                                                    {{ $industry->domain == 'Network Administration' ? 'selected' : '' }}>
                                                                                                    Network Administration
                                                                                                </option>
                                                                                                <option
                                                                                                    value="Database Management"
                                                                                                    {{ $industry->domain == 'Database Management' ? 'selected' : '' }}>
                                                                                                    Database Management
                                                                                                </option>
                                                                                                <option
                                                                                                    value="Cybersecurity"
                                                                                                    {{ $industry->domain == 'Cybersecurity' ? 'selected' : '' }}>
                                                                                                    Cybersecurity</option>
                                                                                                <option
                                                                                                    value="Cloud Computing"
                                                                                                    {{ $industry->domain == 'Cloud Computing' ? 'selected' : '' }}>
                                                                                                    Cloud Computing</option>
                                                                                                <option
                                                                                                    value="Artificial Intelligence"
                                                                                                    {{ $industry->domain == 'Artificial Intelligence' ? 'selected' : '' }}>
                                                                                                    Artificial Intelligence
                                                                                                </option>
                                                                                                <option
                                                                                                    value="Data Science"
                                                                                                    {{ $industry->domain == 'Data Science' ? 'selected' : '' }}>
                                                                                                    Data Science</option>
                                                                                                <option
                                                                                                    value="UI/UX Design"
                                                                                                    {{ $industry->domain == 'UI/UX Design' ? 'selected' : '' }}>
                                                                                                    UI/UX Design</option>
                                                                                            </select>
                                                                                        </div>

                                                                                        {{-- <label for="" class="ti-form-label">Domain :</label>
                                                                            <input type="text" name="domain" class="ti-form-input"   value="{{$industry->domain}}"> --}}
                                                                ...
                                                                <div class="hs-tooltip ti-main-tooltip">
                                                                    <form
                                                                        action="{{ route('internship.industry.destroy', $industry->id) }}"
                                                                        method="post">
                                                    ...
                                                    @empty
                                                        <p class="text-dark"><b>No Industry Added.</b></p>
                                                    @endforelse
                                                @endif
                                            </tbody>
                                        </table>
