                    ...
                    <div class="box">
                        <div class="box-body">
                            <div class="flex">
                                ...
                                <div class="flex-1">
                                    <p class="text-sm font-bold">Total Number of Advisors </p>
                        ...
                        <div class="col-span-12 md:col-span-6 xxl:col-span-3">
                                        ...
                                        <div id="hs-medium-modal" class="hs-overlay hidden ti-modal">
                                            <div
                                                ...
                                                <div class="ti-modal-content">
                                                    ...
                                                    <form action="{{ route('internship.spoc.store') }}" method="post">
                                                        @csrf
                                                        <div class="ti-modal-body">
                                                            ...
                                                            <div class="max-w-sm space-y-3 pb-6">
                                                                ...
                                                                <input type="text" name="name"
                                                                    class="ti-form-input" required placeholder="Name" pattern="^[a-zA-Z\s]+$">
                                                            </div>

                                                            <div class="max-w-sm space-y-3 pb-6">
                                                                <label for="" class="ti-form-label">Phone :
                                                                </label>
                                                                <input type="tel" name="phone" id="phone"
                                                                    class="ti-form-input" required
                                                                    placeholder="Enter Phone number" pattern="^\d{10}$" title="Phone number must be 10 digits">
                                                            </div>

                                                            <div class="max-w-sm space-y-3 pb-6">
                                                                <label for="" class="ti-form-label">Email :
                                                                </label>
                                                            ...
                                                            <div class="max-w-sm space-y-3 pb-6">
                                                                <label for="" class="ti-form-label">Designation :
                                                                </label>
                                                            ...
                                                            <div class="max-w-sm space-y-3 pb-6">
                                                                <label for="" class="ti-form-label">Department :
                                                                </label>
                            ...
                            <div class="box-body">
                                <div
                                    ...
                                    <table id="spoc_table" class="ti-custom-table ti-custom-table-head whitespace-nowrap">
                                        <thead class="bg-gray-50 dark:bg-black/20">
                                            <tr class="">
                                                ...
                                                <th scope="col" class="dark:text-white/80">@sortablelink('phone', 'phone')</th>
                                                <th scope="col" class="dark:text-white/80">@sortablelink('email', 'email')</th>
                                                <th scope="col" class="dark:text-white/80">@sortablelink('designation', 'designation')</th>
                                                <th scope="col" class="dark:text-white/80">@sortablelink('department', 'department')</th>
                                        ...
                                        <tbody class="">
                                            ...
                                            @endphp
                                            @if ($spocs != null)
                                                @forelse($spocs as $spoc)
                                                    <tr class="">
                                                        <td>{{ $counter++ }}</td>
                                                        <td>

                                                            {{ $spoc->industry->name . ',' . $spoc->industry->location }}

                                                        </td>
                                                        <td><span>{{ $spoc->name }}</span></td>
                                                        <td><span>{{ $spoc->phone }}</span></td>
                                                        <td><span>{{ $spoc->email }}</span></td>
                                                        <td><span>{{ $spoc->designation }}</span></td>
                                                        <td><span>{{ $spoc->department }}</span></td>


                                                        <td class="font-medium space-x-2 rtl:space-x-reverse">
                                                            {{-- <div class="hs-tooltip ti-main-tooltip">
                                                                <a href="{{ route('internship.spoc.show', $spoc->id) }}"
                                                            ...
                                                            <div class="hs-tooltip ti-main-tooltip">
                                                                <button
                                                                    data-hs-overlay="#spocs_edit_modal{{ $counter }}"
                                                                ...
                                                                <div id="spocs_edit_modal{{ $counter }}"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="ti-modal-content">
                                                                            ...
                                                                            <form
                                                                                action="{{ route('internship.spoc.update', $spoc->id) }}"
                                                                                method="post">
                                                                                @csrf
                                                                                @method('patch')
                                                                                <div class="ti-modal-body">
                                                                                    ...
                                                                                    <div class="max-w-sm space-y-3 pb-6">
                                                                                        ...
                                                                                        <select name="industry_id"
                                                                                            ...
                                                                                            @foreach ($industries as $ind)
                                                                                                <option
                                                                                                    value="{{ $ind->id }}"
                                                                                                    {{ $spoc->industry_id == $ind->id ? 'selected' : '' }}>
                                                                                                    {{ $ind->name }}
                                                                                                </option>
                                                                                            @endforeach
                                                                                        </select>
                                                                                    ...
                                                                                    <div class="max-w-sm space-y-3 pb-6">
                                                                                        ...
                                                                                        <input type="text"
                                                                                            name="name"
                                                                                            class="ti-form-input"
                                                                                            value="{{ $spoc->name }}" pattern="^[a-zA-Z\s]+$">
                                                                                    </div>

                                                                                    <div class="max-w-sm space-y-3 pb-6">
                                                                                        <label for=""
                                                                                            class="ti-form-label">Phone :
                                                                                        </label>
                                                                                        <input type="tel"
                                                                                            name="phone" id="phone"
                                                                                            class="ti-form-input"
                                                                                            value="{{ $spoc->phone }}"  pattern="^\d{10}$" title="Phone number must be 10 digits">
                                                                                    </div>

                                                                                    <div class="max-w-sm space-y-3 pb-6">
                                                                                        <label for="with-corner-hint"
                                                                                            class="ti-form-label">Email :
                                                                                        </label>
                                                                                        <input type="email"
                                                                                            name="email"
                                                                                            class="ti-form-input"
                                                                                    ...
                                                                                    <div class="max-w-sm space-y-3 pb-6">
                                                                                        <label for="with-corner-hint"
                                                                                            class="ti-form-label">Designation
                                                                                            : </label>
                                                                                        <input type="text"
                                                                                            name="designation"
                                                                                            class="ti-form-input"
                                                                                    ...
                                                                                    <div class="max-w-sm space-y-3 pb-6">
                                                                                        <label for="with-corner-hint"
                                                                                            class="ti-form-label">Department
                                                                                            : </label>
                                                                                        <input type="text"
                                                                                            name="department"
                                                                                            class="ti-form-input"
                                                            ...
                                                            <div class="hs-tooltip ti-main-tooltip">
                                                                <form
                                                                    action="{{ route('internship.spoc.destroy', $spoc->id) }}"
                                                                    method="post">
