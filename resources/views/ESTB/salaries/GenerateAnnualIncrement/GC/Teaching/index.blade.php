                    ...
                    <div class="box-header">
                        ...
                        <div class="block ltr:ml-auto rtl:mr-auto my-auto">
                                    ...
                                    <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                            <div class="ti-modal-content">
                                                ...
                                                <div class="ti-modal-body">
                                                    <form id="annualincrementStaffForm" action="/ESTB/salaries/GenerateAnnualIncrement/GC/Teaching/create" method="post">
                                                        @csrf
                                ...
                                {{-- <div class="avatar-wrapper flex items-center">
                                    <div class="avatar rounded-sm p-1 bg-green-500 border-gray-900 border-2 w-6 h-6">
                                    </div>
                            ...
                            <table id="annualincrement_template_table" class="ti-custom-table ti-custom-table-head whitespace-nowrap">
                                <thead class="bg-gray-50 dark:bg-black/20">
                                    <tr>
                                        ...
                                        <th scope="col" class="dark:text-white/80">Present Basic+AGP</th>
                                        <th scope="col" class="dark:text-white/80">Present Basic Including AGP</th>
                                        <th scope="col" class="dark:text-white/80">Rate of Increment@3% on Basic+AGP</th>
                                        ...
                                        <th scope="col" class="dark:text-white/80">Basic after Increment</th>
        ...
        <script>
            $(document).ready(function(){
               ...
               $('#exportToExcel').on('click', function () {
                    ...
                    setTimeout(function() {
                        window.location.href="{{url('/ESTB/salaries/GenerateAnnualIncrement/GC/Teaching')}}"; // Update this URL to your actual route
                    }, 1000);
                });
            });
            </script>
