                                                ...
                                                <div class=" block ltr:ml-auto rtl:mr-auto my-auto">
                                                    ...
                                                    <div id="hs-medium-modal" class="hs-overlay hidden ti-modal">
                                                        <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                                            ...
                                                            <form action="{{route('ESTB.salaries.salarygroups.store')}}" method="post">
                                                                @csrf
                                                                <div class="ti-modal-body">
                                                                
                                                                    <div class="max-w-sm space-y-3 pb-6">
                                                                        <label for="with-corner-hint" class="ti-form-label font-bold">Group Name:<span class="text-red-500">*</span></label>
                                                                        <input type="text" name="group_name" class="ti-form-input" placeholder="group_name" id="groupName">
                                                                        @if($errors->has('group_name'))
                                                                            <div class="text-red-700">{{ $errors->first('group_name')}}</div>
                                                                        @endif
                                            ...
                                            <div class="ti-custom-table-head overflow-auto ti-striped-table ti-custom-table-hover table-bordered rounded-sm">
                                                <table id="qualification_table"  class="ti-custom-table ti-custom-table-head whitespace-nowrap">
                                                    ...
                                                    <tr class="">
                                                        ...
                                                        <th scope="col" class="dark:text-white/80">@sortablelink('Group Name','Group Name')</th>
                                                    ...
                                                    <tr class="">
                                                            ...
                                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16"><path d="M16.7574 2.99666L14.7574 4.99666H5V18.9967H19V9.2393L21 7.2393V19.9967C21 20.5489 20.5523 20.9967 20 20.9967H4C3.44772 20.9967 3 20.5489 3 19.9967V3.99666C3 3.44438 3.44772 2.99666 4 2.99666H16.7574ZM20.4853 2.09717L21.8995 3.51138L12.7071 12.7038L11.2954 12.7062L11.2929 11.2896L20.4853 2.09717Z"></path></svg>
                                                                ...
                                                                <div id="qual_edit_modal{{$i}}" class="hs-overlay hidden ti-modal">
                                                                    <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                                                        ...
                                                                        <form  action="{{route('ESTB.salaries.salarygroups.update',$sg->id)}}" method="post">
                                                                            @csrf
                                                                            @method('patch')
                                                                            <div class="ti-modal-body">
                                                                                ...
                                                                                <div class="max-w-sm space-y-3 pb-6">
                                                                                    ...
                                                                                    <input type="text" name="edit_groupname" class="ti-form-input" required placeholder="group_name" value="{{$sg->group_name}}">
                                                                                    
                                                                                </div>
                                                                               
                                                                    
                                                                                @if($sg->status == 'inactive')
                                                                                <br/>
                                                                                    <div class="flex">
                                                        ...
                                                        <div class="hs-tooltip ti-main-tooltip">
                                                        <form action="{{ route('ESTB.salaries.salarygroups.destroy',$sg->id) }}" method="post">
