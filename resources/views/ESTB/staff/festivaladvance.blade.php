            ...
            <div class=" block ltr:ml-auto rtl:mr-auto my-auto">
                    ...
                    <div id="hs-medium-modal" class="hs-overlay hidden ti-modal">
                        <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                            ...
                            <form action="{{route('ESTB.staff.festivaladvance.store',$staff->id)}}" method="post">
                                @csrf
                                <div class="ti-modal-body">
                                 ...
                                 <div class="grid lg:grid-cols-2 gap-2 space-y-2 lg:space-y-0">
                                    ...
                                    {{-- <div class="max-w-sm space-y-3 pb-6">
                                     ...
                                     {{-- <div class="max-w-sm space-y-3 pb-6">
                                        <label for="with-corner-hint" class="ti-form-label"> Date of Disburesement : </label>
                                        <input type="text" name="date_of_disbursement" class="ti-form-input" placeholder="date of disburesement">
                                    </div> --}}
                                ...
                                <div class="ti-modal-footer">
                                    ...
                                    <input type="submit" id="festivaladvance_store" class="ti-btn  bg-primary text-white hover:bg-primary  focus:ring-primary  dark:focus:ring-offset-white/10" value="Add"/>
        ...
        <div class="table-bordered rounded-sm ti-striped-table ti-custom-table-head overflow-auto">
           <table id="table" class="ti-custom-table ti-custom-table-head whitespace-nowrap">
            ...
            <tr class="">
                ...
                <th scope="col" class="dark:text-white/80">Date of disburesement</th>
            ...
            <tbody class="">
                ...
                @if($staff->festivaladvance!=null)
                 @forelse($staff->festivaladvance as $fa)
                    <tr class="">
                        <td>{{$i++ }}</td>
                    ...
                    <td class="font-medium space-x-2 rtl:space-x-reverse">
                        <div class="hs-tooltip ti-main-tooltip">
                                ...
                                <div id="asso_edit_modal{{$i}}" class="hs-overlay hidden ti-modal">
                                    <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                        ...
                                        <div class="ti-modal-header">
                                            ...
                                            <button type="button" class="hs-dropdown-toggle ti-modal-close-btn"
                                            data-hs-overlay="#asso_edit_modal{{$i}}">
                                            <span class="sr-only">Close</span>
                                            <svg class="w-3.5 h-3.5" width="8" height="8" viewBox="0 0 8 8" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                        ...
                                        <form action="{{route('ESTB.festivaladvance.update',[$staff->id,$fa->id])}}" method="post">
                                            ...
                                            <div class="space-y-2">
                                                ...
                                                {{-- <div class="max-w-sm space-y-3 pb-6">
                                                    <label for="with-corner-hint" class="ti-form-label">Date of Disburesement: </label>
                                                    <input type="text" name="date_of_disbursement" class="ti-form-input" placeholder="date_of_disbursement">
                         ...
                         <div class="hs-tooltip ti-main-tooltip">
                                <form action="{{route('ESTB.festivaladvance.destroy',[$staff->id,$fa->id])}}" method="post">   
                                 @method('delete')
                                     @csrf
