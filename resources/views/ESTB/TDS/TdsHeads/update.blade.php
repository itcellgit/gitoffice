                                    ...
                                    <div class="box-body">
                                        ...
                                        <table id="religion_table" class="ti-custom-table ti-custom-table-head whitespace-nowrap">
                                            ...
                                            <tr class="">
                                                ...
                                                <th scope="col" class="dark:text-white/80">Section Name</th>
                                            ...
                                            <tbody class="">
                                                @php
                                                    $i = 1;
                                                @endphp
                                                @forelse($invest_category as $category)
                                                ...
                                                <tr class="">
                                                    ...
                                                    <div class="flex space-x-3 rtl:space-x-reverse w-full min-w-[200px]">
                                                        <div class="block w-full my-auto">
                                                           {{ $category->tdshead->category }}
                                                        </div>
                                                    </div>
                                                    </td>
                                                    <td><span>{{ $category->investment_type }}</span></td>
                                                    <td><span>{{ $category->tdshead->status }}</span></td>
                                                    <td class="font-medium space-x-2 rtl:space-x-reverse">
                                                        {{-- <div class="hs-tooltip ti-main-tooltip">
                                                                    <a href="{{route('ESTB.TDS.TdsHeads.show',$tdshead->id)}}"
