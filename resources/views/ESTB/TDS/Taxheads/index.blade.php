                                        ...
                                        <div class="box-header">
                                            ...
                                            <div class=" block ltr:ml-auto rtl:mr-auto my-auto">
                                                    ...
                                                    <div id="hs-medium-modal" class="hs-overlay hidden ti-modal">
                                                        ...
                                                        <form action="{{route('ESTB.TDS.Taxheads.store')}}" method="post">
                                                            @csrf
                                                            <div class="ti-modal-body">
                                                                <div class="max-w-sm space-y-3">
                                                                    <label for="with-corner-hint" class="ti-form-label">Tax Regime name: </label>
                                                                    <input type="text" id="name" name="name" class="ti-form-input" placeholder="Tax Regime name">
                                                                    @if($errors->has('name'))
                                                                        <div class="text-red-700">{{ $errors->first('name')}}</div>
                                                                    @endif
                                                                    <div id="regimeNameError" class="error text-red-700"></div>
                                                                </div>
                                                                <div class="max-w-sm space-y-3">
                                                                    <label for="with-corner-hint" class="ti-form-label">year </label>
                                                                    <input type="text" id="year" name="year" class="ti-form-input" placeholder="year">
                                                                    @if($errors->has('year'))
                                    ...
                                    <div class="box-body">
                                        ...
                                        <table id="religion_table" class="ti-custom-table ti-custom-table-head whitespace-nowrap">
                                            ...
                                            <tr class="">
                                                ...
                                                <th scope="col" class="dark:text-white/80">Tax Regime Name</th>
                                            ...
                                            <tbody class="">
                                                ...
                                                <tr class="">
                                                    ...
                                                    <td><span>{{ $taxhead->year }}</span></td>
                                                    <td><span>{{ $taxhead->status }}</span></td>
                                                    <td class="font-medium space-x-2 rtl:space-x-reverse">
                                                    <div class="hs-tooltip ti-main-tooltip">
                                                                <a href="{{route('ESTB.TDS.Taxheads.show',$taxhead->id)}}"
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16"><path d="M16.7574 2.99666L14.7574 4.99666H5V18.9967H19V9.2393L21 7.2393V19.9967C21 20.5489 20.5523 20.9967 20 20.9967H4C3.44772 20.9967 3 20.5489 3 19.9967V3.99666C3 3.44438 3.44772 2.99666 4 2.99666H16.7574ZM20.4853 2.09717L21.8995 3.51138L12.7071 12.7038L11.2954 12.7062L11.2929 11.2896L20.4853 2.09717Z"></path></svg>
                                                            ...
                                                            <div id="religion_edit_modal{{$i}}" class="hs-overlay hidden ti-modal">
                                                                <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                                                    ...
                                                                    <form  action="{{route('ESTB.TDS.Taxheads.update',$taxHeads->first()->id)}}" method="post">
                                                                        @csrf
                                                                        @method('patch')
                                                                        <div class="ti-modal-body">
                                                                           ...
                                                                           <input type='hidden' name='religion_modal_no' class='religion_modal_no' value={{old('religion_modal_no')}}/>
                                                                            <div class="max-w-sm space-y-3">
                                                                                <label for="with-corner-hint" class="ti-form-label">TaxHeads Name : </label>
                                                                                <input type="text" name="edit_taxheads_name" class="ti-form-input" placeholder="TaxHeads name" value="{{$taxhead->name}}">
                                                                                @if($errors->has('edit_taxheads_name'))
                                                                                    <div class="text-red-700">{{ $errors->first('edit_taxheads_name')}}</div>
                                                                                @endif
                                                                                <div id="religionNameError" class="error text-red-700"></div>
                                                                            </div>
                                                                            <div class="max-w-sm space-y-3">
                                                                                <label for="with-corner-hint" class="ti-form-label">year </label>
                                                                                <input type="text" name="edit_year" class="ti-form-input" placeholder="year" value="{{$taxhead->year}}">
                                                                                @if($errors->has('edit_year'))
                                                                                    <div class="text-red-700">{{ $errors->first('edit_year')}}</div>
                                                                                @endif
                                                                                <div id="yearError" class="error text-red-700"></div>
                                                                            </div>
                                                                            
                                                                            @if($taxhead->status == 'Inactive')
                                                                            <br/>
                                                                                <div class="flex">
                                                    ...
                                                    <div class="hs-tooltip ti-main-tooltip">
                                                    <form action="{{ route('ESTB.TDS.Taxheads.destroy',$taxHeads->first()->id) }}" method="post">
                                                ...
                                                @empty
                                                    <p class="text-dark"><b>No TaxHeads Added.</b></p>
                                                @endforelse
                                                </tbody>
                                            </table>
                                            </div>
