                                        ...
                                        <div class="box-header">
                                            ...
                                            <div class=" block ltr:ml-auto rtl:mr-auto my-auto">
                                                    ...
                                                    <div id="add_caste_category" class="hs-overlay hidden ti-modal">
                                                        ...
                                                        <form action="{{route('ESTB.TDS.Taxheads.Taxslabs.store',$taxHeads->id)}}" data-remote="true"  method="post">
                                                            @csrf
                                                            <div class="ti-modal-body">
                                                               <input type="hidden" name="regime_id" value="{{$taxHeads->id}}">
                                                                <div class="max-w-sm space-y-3 pb-6">
                                                                    ...
                                                                    <input type="number" id="lower_limit" name="lower_limit" id="lower_limit" class="ti-form-input {{$errors->has('lower_limit')? 'border-red-500':''}}" placeholder="lower limit" value={{old('lower_limit')}}>
                                                                    @if($errors->has('lower_limit'))
                                                                            <div class="text-red-700">{{ $errors->first('lower_limit')}}</div>
                                                                    @endif
                                                                    <div id="lowerlimitError" class="error text-red-700"></div>
                                                                </div>
                                                                <div class="max-w-sm space-y-3 pb-6">
                                                                    <label for="with-corner-hint" class="ti-form-label font-bold">Upper limit : </label>
                                                                    <input type="text" id="upper_limit" name="upper_limit" class="ti-form-input {{$errors->has('upper_limit')? 'border-red-500':''}}" placeholder="upper_limit" value={{old('upper_limit')}}>
                                                                    @if($errors->has('upper_limit'))
                                                                            <div class="text-red-700">{{ $errors->first('upper_limit') }}</div>
                                                                    @endif
                                                                    <div id="upper_limitNameError" class="error text-red-700"></div>
                                                                </div>
                                                                <div class="max-w-sm space-y-3 pb-6">
                                                                    <label for="with-corner-hint" class="ti-form-label font-bold">Tax rate : </label>
                                                                    <input type="text" id="tax_rate" name="tax_rate" class="ti-form-input {{$errors->has('tax_rate')? 'border-red-500':''}}" placeholder="tax rate" value={{old('tax_rate')}}>
                                                                    @if($errors->has('tax_rate'))
                                                                            <div class="text-red-700">{{ $errors->first('tax_rate') }}</div>
                                                                    @endif
                                                                    <div id="tax_rateNameError" class="error text-red-700"></div>
                                                                </div>
                                                            </div>
                                    ...
                                    <div class="box-body">
                                        ...
                                        <table id="castecategory_table" class="ti-custom-table ti-striped-table  ti-custom-table-head whitespace-nowrap">
                                            ...
                                            <tr class="">
                                                ...
                                                <th scope="col" class="dark:text-white/80">TaxHead</th>
                                                <th scope="col" class="dark:text-white/80">Lower limit</th>
                                                <th scope="col" class="dark:text-white/80">Upper limit</th>
                                                <th scope="col" class="dark:text-white/80">Tax rate</th>
                                            ...
                                            <tbody class="">
                                                ...
                                                <tr class="">
                                                                        ...
                                                                        <form  action="{{route('ESTB.TDS.Taxheads.Taxslabs.update',[$taxHeads->id,$taxSlabs->id])}}" method="post">
                                                                            ...
                                                                            <div class="ti-modal-body pb-6">
                                                                                ...
                                                                                <div class="max-w-sm space-y-3 pb-6">
                                                                                    ...
                                                                                    @if($errors->has('e_lower_limit'))
                                                                                        <div class="text-red-700">{{ $errors->first('e_lower_limit') }}</div>
                                                                                    @endif
                                                                                    <div id="lowerlimitError" class="error text-red-700"></div>
                                                                                </div>
                                                                                <div class="max-w-sm space-y-3 pb-6">
                                                                                    ...
                                                                                    @endif
                                                                                    <div id="upperlimitError" class="error text-red-700"></div>
                                                                                </div>
                                                                                <div class="max-w-sm space-y-3 pb-6">
                                                                                    <label for="with-corner-hint" class="ti-form-label font-bold">Tax Rate </label>
                                                                                    <input type="text" name="e_tax_rate" class="ti-form-input" placeholder="tax rate" value="{{$taxSlabs->tax_rate}}">
                                                                                    @if($errors->has('e_tax_rate'))
                                                                                        <div class="text-red-700">{{ $errors->first('e_tax_rate') }}</div>
                                                                                    @endif
                                                                                    <div id="taxrateError" class="error text-red-700"></div>
                                                                                </div>
                                                    ...
                                                    @empty
                                                        <p class="text-dark"><b>No TaxSlabs addes.</b></p>
                                                    @endforelse
                                                    </tbody>
                                                </table>
                                                </div>
