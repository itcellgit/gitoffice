            ...
            <ol class="flex items-center whitespace-nowrap min-w-0">
                <li class="text-sm">
                    <a class="flex items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="javascript:void(0);">
                        ...
                        Annual Increment Template For Board
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16">
                ...
                <div class="box">
                    <div class="box-header">
                        <div class="flex">
                            <h5 class="box-title my-auto">
                                ...
                                Annual Increment Staff Template For Board
                            </h5>
                        ...
                        <div class="block ltr:ml-auto rtl:mr-auto my-auto">
                                    <button type="button" id="downloadtemp" data-hs-overlay="#downloadTemp" class="hs-dropdown-toggle ti-btn ti-btn-primary">
                                        ...
                                        Generate Annual Increment List For Board
                                    </button>
                                    ...
                                    <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                            <div class="ti-modal-content">
                                                ...
                                                <div class="ti-modal-body">
                                                    <form id="annualincrementStaffFormforboard" action="/ESTB/Generateannualincrementteachingboard/create" method="post">
                                                        @csrf
                    ...
                    {{-- <form id="generateannualincrementForm" method="POST" action="{{ route('generateannualincrement.staff.update') }}">
                        ...
                        <div id="basic-table" class="ti-custom-table ti-striped-table  ti-custom-table-hover table-bordered rounded-sm overflow-auto">
                            ...
                            <table id="annualincrement_template_board_table" class="ti-custom-table ti-custom-table-head whitespace-nowrap">
                                <thead class="bg-gray-50 dark:bg-black/20">
                                    <tr>
                                        ...
                                        <th scope="col" class="dark:text-white/80">basic pay after incremnt</th>
                                    </tr>
                                </thead>                                                   
                            </table>
