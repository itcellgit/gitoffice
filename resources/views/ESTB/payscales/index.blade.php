                                ...
                                <div class="col-span-12">
                                    ...
                                    <div class="box-header">
                                        ...
                                        <h5 class="box-title my-auto">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16"><path d="M22.0049 7H23.0049V17H22.0049V20C22.0049 20.5523 21.5572 21 21.0049 21H3.00488C2.4526 21 2.00488 20.5523 2.00488 20V4C2.00488 3.44772 2.4526 3 3.00488 3H21.0049C21.5572 3 22.0049 3.44772 22.0049 4V7ZM20.0049 17H14.0049C11.2435 17 9.00488 14.7614 9.00488 12C9.00488 9.23858 11.2435 7 14.0049 7H20.0049V5H4.00488V19H20.0049V17ZM21.0049 15V9H14.0049C12.348 9 11.0049 10.3431 11.0049 12C11.0049 13.6569 12.348 15 14.0049 15H21.0049ZM14.0049 11H17.0049V13H14.0049V11Z" fill="rgba(0,0,0,1)"></path></svg>
                                        Salary Type  Details</h5>
                                        <div class=" block ltr:ml-auto rtl:mr-auto my-auto">
                                                <button type="button" class="hs-dropdown-toggle ti-btn ti-btn-primary" data-hs-overlay="#add_payscale">
                                                ...
                                                <div id="add_payscale" class="hs-overlay hidden ti-modal">
                                                    <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                                        ...
                                                        <form  action="{{route('ESTB.payscales.store')}}" method="post">
                                                            @csrf
                                                            <div class="ti-modal-body">
                                                               
                                                                <div class="max-w-sm space-y-3">
                                                                    <label for="with-corner-hint" class="ti-form-label">Salary Type :<span class="text-red-500">*</span> </label>
                                                                    <input type="text" name="payscale" class="ti-form-input" required placeholder="Payscale">
                                                                </div>
                                                                <div class="max-w-sm space-y-3">
                                                                    <label for="with-corner-hint" class="ti-form-label">Description</label>
                                                                    <textarea type="text" name="description" class="ti-form-input" required placeholder="Description"></textarea>
                                                                </div>
                                    ...
                                    <div class="ti-custom-table-head overflow-auto ti-striped-table ti-custom-table-hover table-bordered rounded-sm">
                                        <table class="ti-custom-table ti-custom-table-head whitespace-nowrap">
                                            ...
                                            <tr class="">
                                                ...
                                                <th scope="col" class="dark:text-white/80">Salary Type</th>
                                            ...
                                            <tr class="">
                                                ...
                                                <td><span>{{$pay->description}}</span></td>
                                                <td><span>{{$pay->status}}</span></td>


                                                <td class="font-medium space-x-2 rtl:space-x-reverse">
                                                <div class="hs-tooltip ti-main-tooltip">
                                                            <a href="{{route('ESTB.payscale.payscalesalaryheads.show',$pay->id)}}"
                                                ...
                                                <!--<td class="font-medium space-x-2 rtl:space-x-reverse">-->
                                                <div class="hs-tooltip ti-main-tooltip">
                                                    <button data-hs-overlay="#edit_payscale_modal{{$i}}"
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16"><path d="M16.7574 2.99666L14.7574 4.99666H5V18.9967H19V9.2393L21 7.2393V19.9967C21 20.5489 20.5523 20.9967 20 20.9967H4C3.44772 20.9967 3 20.5489 3 19.9967V3.99666C3 3.44438 3.44772 2.99666 4 2.99666H16.7574ZM20.4853 2.09717L21.8995 3.51138L12.7071 12.7038L11.2954 12.7062L11.2929 11.2896L20.4853 2.09717Z"></path></svg>
                                                        ...
                                                        <div id="edit_payscale_modal{{$i}}" class="hs-overlay hidden ti-modal">
                                                            <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                                                <div class="ti-modal-content">
                                                                <div class="ti-modal-header">
                                                                    <h3 class="ti-modal-title">
                                                                    ...
                                                                    <button type="button" class="hs-dropdown-toggle ti-modal-close-btn"
                                                                    data-hs-overlay="#edit_payscale_modal{{$i}}l">
                                                                    <span class="sr-only">Close</span>
                                                                    <svg class="w-3.5 h-3.5" width="8" height="8" viewBox="0 0 8 8" fill="none"
                                                                        xmlns="http://www.w3.org/2000/svg">
                                                                        <path
                                                                ...
                                                                <form  action="{{route('ESTB.payscales.update',$pay->id)}}" method="post">
                                                                    @csrf
                                                                    @method('patch')
                                                                    <div class="ti-modal-body">
                                                                       
                                                                        <div class="max-w-sm space-y-3">
                                                                            <label for="with-corner-hint" class="ti-form-label">Salary Type: </label>
                                                                            <input type="text" name="edit_payscale" class="ti-form-input" required placeholder="Salary type" value="{{$pay->payscale}}">
                                                                        </div>

                                                                        <div class="max-w-sm space-y-3">
                                                                            <label for="with-corner-hint" class="ti-form-label">Description: </label>
                                                                            <input type="text" name="edit_description" class="ti-form-input" required placeholder="Description" value="{{$pay->description}}">
                                                                        </div>
                                                                    ...
                                                                    <div class="ti-modal-footer">
                                                                        <button type="button"
                                                                        class="hs-dropdown-toggle ti-btn ti-border font-medium bg-white text-gray-700 shadow-sm align-middle hover:bg-gray-50 focus:ring-offset-white focus:ring-primary dark:bg-bgdark dark:hover:bg-black/20 dark:border-white/10 dark:text-white/70 dark:hover:text-white dark:focus:ring-offset-white/10"
                                                                        data-hs-overlay="#edit_payscale_modal{{$i}}">
                                                                        Close
                                                                        </button>
                                                ...
                                                <div class="hs-tooltip ti-main-tooltip">
                                                <form action="{{ route('ESTB.payscales.destroy',$pay->id) }}" method="post">
                                            ...
                                            @empty
                                                <p class="text-dark"><b>No Salarytype Added.</b></p>
                                            @endforelse
                                            </tbody>
                                        </table>
                                        </div>
