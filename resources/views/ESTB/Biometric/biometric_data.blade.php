                    ...
                    <div class="box">
                        <div class="box-header">
                            <div class="flex">
                                ...
                                <h4 class="box-title my-auto" style="display: inline-block;">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="32" height="32" fill="currentColor"><path d="M12 1C16.9706 1 21 5.02944 21 10V14C21 17.0383 19.4945 19.7249 17.1887 21.3546C17.7164 19.6635 18 17.8649 18 16L17.9996 13.999H15.9996L16 16L15.997 16.3149C15.9535 18.5643 15.4459 20.7 14.5657 22.6304C13.7516 22.8705 12.8909 23 12 23C11.6587 23 11.3218 22.981 10.9903 22.944C12.2637 20.9354 13 18.5537 13 16V9H11V16L10.9963 16.2884C10.9371 18.5891 10.1714 20.7142 8.90785 22.4547C7.9456 22.1028 7.05988 21.5909 6.28319 20.9515C7.35876 19.5892 8 17.8695 8 16V10L8.0049 9.80036C8.03767 9.1335 8.23376 8.50957 8.554 7.96773L7.10935 6.52332C6.41083 7.50417 6 8.70411 6 10V16L5.99586 16.2249C5.95095 17.4436 5.54259 18.5694 4.87532 19.4973C3.69863 17.9762 3 16.0697 3 14V10C3 5.02944 7.02944 1 12 1ZM12 4C10.7042 4 9.50434 4.41077 8.52353 5.10921L9.96848 6.55356C10.5639 6.20183 11.2584 6 12 6C14.2091 6 16 7.79086 16 10V12H18V10C18 6.68629 15.3137 4 12 4Z"></path></svg>
                                    Biometric  Details
                                </h4>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="ml- mt-4" style="padding: 30px;">
                                <span id="display_date_message" style="font-size: 18px;"></span>
                            </div>
                                                
                            <!--search and missing bio-->
                                        ...
                                        <div style="display: flex; flex-direction: row; align-items: center; margin-left: 10px;">
                                            <div class="grid gap-1 space-y-2 lg:grid-cols-1 lg:space-y-0">
                                                <div class="flex flex-col lg:flex-row items-start lg:items-center justify-start lg:justify-between ml-10">
                                                    ...
                                                    <div class="flex items-center justify-end mt-2 lg:mt-0 ml-0 lg:ml-4">
                                                       
                                                        <button type="submit" class="bg-blue-500 text-white px-4 py-2 text-xs rounded-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75 whitespace-nowrap">Search</button>
                                                        <div class="ml-2">
                                                            
                                                            <button type="submit" id="missing-biometric-button" data-hs-overlay="#missing-biometric-modal" class="bg-green-500 text-white px-4 py-2 text-xs rounded-md focus:outline-none hover:bg-green-600 focus:ring-2 focus:ring-green-400 focus:ring-opacity-75 whitespace-nowrap">Missing Biometric</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            $.each(response, function(index, value) {
                                ...
                                $('#missing-biometric-data').append(
                                    '<tr>' +
                                        ...
                                        $.each(value.leave_staff_applications, function($i,$appl)
                                        {
                                                
                                            $('#missing-biometric-data').append(
                                                '<td>' + $appl.shortname + '</td>');
                                        }
                                      
                                    $('#missing-biometric-data').append(  '</tr>');
                                );
                            });
                    ...
                    success: function(response) {
                        ...
                        if (response.length != 0) {
                            $.each(response, function(index, value) {
                                ...
                                // Append each leave application data
                                $.each(value.leave_staff_applications, function($i, $appl) {
                                    $('#missing-biometric-data').append(
                                        '<td>' + $appl.shortname + '</td>'
                                    );
                ...
                if (response.length != 0) {
                    $.each(response, function(index, value) {
                       // console.log(value.leave_staff_applications);
                        ...
                        // Append each leave application data
                        // $.each(value.leave_staff_applications, function($i, $appl) {
                        //     if(value.leave_staff_applications.length !=0){
                        //         $('#missing-biometric-data').append(
                        //         '<td>' + $appl.shortname + '</td>'
                        //         );
                        //     }else{
    ...
    <script>
        function setCurrentDate() {
            ...
            if (selectedDate) {
                ...
                displayMessage.innerHTML = "<strong>Displaying  Biometric Data for the Date: " + selectedDate + "</strong>";
            } else {
                ...
                displayMessage.innerHTML = "    <strong>Displaying  Biometric Data for the Date: " + formattedDate + "</strong>";
            }
        }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('to_date').addEventListener('change', function() {
                ...
                var message = "     <strong>Displaying  Biometric Data for the Date: " + selectedDate + "</strong>";
