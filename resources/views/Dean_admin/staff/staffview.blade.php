            ...
            $(document).ready(function(){
             ...
             $(document).on('change','input[type=radio][name=edit_teaching_pay_type]',function(){
               ...
               $(document).on('click','#qualification',function(){
                //alert('Ajax calling');
                var staff=$('#staff').val();
                var url=base_url+'/Dean_admin/staff/'+staff+'/qualifications';
                //alert(url);
                        $.ajax({
                                    url:url,
                                    method:'GET',
                ...
                $(document).on('click','#profile-settings-item-3',function(){
                    //alert('Ajax calling');
                    var staff=$('#staff').val();
                    var url= base_url+'/Dean_admin/staff/'+staff+'/associations';
                    //alert(url);
                    $.ajax({
                                url:url,
                                method:'GET',
                ...
                $(document).on('click','#profile-settings-item-2',function(){
                    //alert('Ajax calling');
                    var staff=$('#staff').val();
                    var url=base_url+'/Dean_admin/staff/'+staff+'/departments';
                    //alert(url);
                    $.ajax({
                            url:url,
                            method:'GET',
                ...
                $(document).on('click','#profile-settings-item-4',function(){
                    //alert('Ajax calling');
                    var staff=$('#staff').val();
                    var url=base_url+'/Dean_admin/staff/'+staff+'/designationpayscales';
                    //alert(url);
                    $.ajax({
                                url:url,
                                method:'GET',
