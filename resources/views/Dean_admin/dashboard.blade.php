                    ...
                    <div class="content">
                        ...
                        <div class="main-content">
                            ...
                            <div class="block justify-between page-header sm:flex">
                                <div>
                                    <h3 class="text-gray-700 hover:text-gray-900 dark:text-white dark:hover:text-white text-2xl font-medium"> Dean Admin Dashboard</h3>
                                </div>
                                    ...
                                    <div class="box" style="height: 450px; overflow-y: auto;">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <ul class="list-unstyled timeline-widget mb-0">
                                                @foreach ($dean_admin_event as $event)
                                ...
                                <div class="col-span-12 md:col-span-6 xxl:col-span-3">
                                    ...
                                    <div class="box-body">
                                        <ul class="list-unstyled mb-0">
                                            @foreach ($dean_admin_notice as $dn)
