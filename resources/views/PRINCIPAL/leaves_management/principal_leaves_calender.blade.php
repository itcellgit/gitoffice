            ...
            $(document).ready(function(){
                ...
                $(document).on('click','.approve_leave',function(){
                    ...
                    if(comfirmation_status){
                        $.ajax({
                                url: base_url+'/PRINCIPAL/leaves_management/approve_leave',
                                    method: 'GET',
                                    data: {
                ...
                $(document).on('click','.reject_leave',function(){
                    ...
                    if(comfirmation_status){
                        $.ajax({
                                url: base_url+'/PRINCIPAL/leaves_management/reject_leave',
                                    method: 'GET',
                                    data: {
                                        application_id : application_id,
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                const calendar = new FullCalendar.Calendar(calendarEl, {
                    ...
                    eventSources: [
                    {
                        ...
                        url: base_url+'/PRINCIPAL/leaves_management/hollidayrh_events',
                    ...
                    {
                        url: base_url+'/PRINCIPAL/leaves_management/fetchAllleaveevents',
                        method: 'GET',
                        success:function(data){
                        console.log(data);
                        },
                    ...
                    eventClick: function(info) {
                        ...
                        $.ajax({
                            ...
                            url: base_url+'/PRINCIPAL/leaves_management/fetchholidayrhevents',
                            method: 'GET',
                            data: {
                                date: clicked_date,
                                _token : '{{csrf_token()}}' // Pass the clicked date to the server
                    ...
                    //ajax call for loading the leave events on calender
                        $.ajax({
                            ...
                            url: base_url+'/PRINCIPAL/leaves_management/fetchleaveevents',
                            method: 'GET',
                            data: {
                                date: clicked_date,
                                _token : '{{csrf_token()}}' // Pass the clicked date to the server
