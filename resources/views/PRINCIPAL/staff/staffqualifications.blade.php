            ...
            <div id="change_qualification" class="hs-overlay hidden ti-modal">
                <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 md:mx-auto">
                    <div class="ti-modal-content">
                        ...
                        <form  action="{{route('PRINCIPAL.staff.qualification.store',$staff->id)}}" method="post">
                            @csrf
                        ...
                        @forelse($staff->qualifications as $qualification)
                            <tr>
                                ...
                                <td class="font-medium space-x-2 rtl:space-x-reverse">
                                        ...
                                        <div id="qual_edit_modal{{$i}}" class="hs-overlay hidden ti-modal">
                                            <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 md:mx-auto">
                                                <div class="ti-modal-content">
                                                    ...
                                                    <form action="{{route('PRINCIPAL.staff.qualification.update',[$staff->id,$qualification->id])}}" method="post">
                                                        @csrf
                                                        @method('patch')
                                                        <div class="ti-modal-body">
                                                            <div class="grid lg:grid-cols-2 gap-1 space-y-2 lg:space-y-0">
                                    ...
                                    <div class="hs-tooltip ti-main-tooltip">
                                        <form action="{{ route('PRINCIPAL.staff.qualification.destroy',[$staff->id,$qualification->id]) }}" method="post">
