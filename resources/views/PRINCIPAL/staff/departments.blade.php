        ...
        <div id="change_department" class="hidden hs-overlay ti-modal">
            <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 md:mx-auto">
                <div class="ti-modal-content">
                    ...
                    <form  action="{{route('PRINCIPAL.staff.department.update',$staff->id)}}" method="post">
                        @csrf
                        @method('patch')
                    ...
                    <tr class="{{$dept->pivot->status =='active'?'':'bg-gray-200'}}">
                        ...
                        <td>
                            ...
                            <div id="edit_department{{$i}}" class="hidden hs-overlay ti-modal">
                                <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                    <div class="ti-modal-content">
                                        ...
                                        <form  action="{{route('PRINCIPAL.staff.department.correction',[$staff->id,$dept->id])}}" method="post">
                                            @csrf
                                            @method('patch')
                                            <div class="ti-modal-body">
                            ...
                            <div class="hs-tooltip ti-main-tooltip">
                                <form action="{{ route('PRINCIPAL.staff.departments.destroy',[$staff->id,$dept->pivot->id]) }}" method="post">
