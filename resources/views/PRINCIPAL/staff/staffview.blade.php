                    ...
                    <div class="main-content">
                        ...
                        <div class="block justify-between page-header sm:flex">
                            ...
                            <ol class="flex items-center whitespace-nowrap min-w-0">
                                <li class="text-sm">
                                <a class="flex items-center font-semibold text-primary hover:text-primary dark:text-primary truncate" href="{{route('PRINCIPAL.staff')}}">
                                    Staff
            ...
            $(document).ready(function(){
                ...
                //while adding the consolidated field if the association choosen is contractual part time.
                    ...
                    $(document).on('change','input[type=radio][name=pay_type]',function(){
                          //  alert($(this).val());
                            ...
                            $.ajax({
                                    url:base_url+'/PRINCIPAL/staff/getstaffpay_list',
                                    method:'GET',
                                    headers: {
                                            'Access-Control-Allow-Origin': '*',
                                            },
             ...
             $(document).on('change','input[type=radio][name=edit_teaching_pay_type]',function(){
               ...
               $(document).on('click','#qualification',function(){
                //alert('Ajax calling');
                var staff=$('#staff').val();
                var url=base_url+'/PRINCIPAL/staff/'+staff+'/qualifications';
                //alert(url);
                        $.ajax({
                                    url:url,
                                    method:'GET',
                ...
                $(document).on('click','#profile-settings-item-3',function(){
                    //alert('Ajax calling');
                    var staff=$('#staff').val();
                    var url= base_url+'/PRINCIPAL/staff/'+staff+'/associations';
                    //alert(url);
                    $.ajax({
                                url:url,
                                method:'GET',
                ...
                $(document).on('click','#profile-settings-item-2',function(){
                    //alert('Ajax calling');
                    var staff=$('#staff').val();
                    var url=base_url+'/PRINCIPAL/staff/'+staff+'/departments';
                    //alert(url);
                    $.ajax({
                            url:url,
                            method:'GET',
                ...
                $(document).on('click','#profile-settings-item-4',function(){
                    //alert('Ajax calling');
                    var staff=$('#staff').val();
                    var url=base_url+'/PRINCIPAL/staff/'+staff+'/designationpayscales';
                    //alert(url);
                    $.ajax({
                                url:url,
                                method:'GET',
