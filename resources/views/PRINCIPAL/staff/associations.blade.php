            ...
            <div id="change_association" class="hs-overlay hidden ti-modal">
                <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                    <div class="ti-modal-content">
                        ...
                        <form  action="{{route('PRINCIPAL.staff.association.update',$staff->id)}}" method="post">
                            @csrf
                            @method('patch')
                        ...
                        <td>
                            ...
                            @if($association->pivot->status == 'active')
                                ...
                                <div id="edit_asociation{{$i}}" class="hs-overlay hidden ti-modal">
                                    <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                        <div class="ti-modal-content">
                                            ...
                                            <form  action="{{route('PRINCIPAL.staff.association.correction',[$staff->id,$association->id])}}" method="post">
                                                @csrf
                                                @method('patch')
                                                <div class="ti-modal-body">
                                ...
                                <div class="hs-tooltip ti-main-tooltip">
                                    <form action="{{ route('PRINCIPAL.staff.associations.destroy',[$staff->id,$association->id]) }}" method="post">
