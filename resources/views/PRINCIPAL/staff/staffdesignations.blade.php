            ...
            <div id="change_designation" class="hs-overlay hidden ti-modal">
                <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                    <div class="ti-modal-content">
                        ...
                        <form action="{{route('PRINCIPAL.staff.designationpayscale.update',$staff->id)}}" method="post">
                            @csrf
                            @method('patch')
                                    ...
                                    @if($designation->pivot->end_date == null)
                                        ...
                                        <div id="edit_designation{{$i}}" class="hs-overlay hidden ti-modal">
                                            <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                                <div class="ti-modal-content">
                                                    ...
                                                    <form  action="{{route('PRINCIPAL.staff.designation.currentupdate',[$staff->id,$designation->id])}}" method="post">
                                                        @csrf
                                                        @method('patch')
                                                        <div class="ti-modal-body">
                                        ...
                                        @if($designation->pivot->status == 'active' && ($difference->y ==0 && $difference->m <= 1))
                                            <div class="hs-tooltip ti-main-tooltip">
                                                <form action="{{ route('PRINCIPAL.staff.designation.currentdestroy',[$staff->id,$designation->id]) }}" method="post">
                                                    ...
                                                    <td>
                                                        @if($payscale->pivot->end_date == null)
                                                            ...
                                                            <div id="edit_teaching_payscale{{$i}}" class="hs-overlay hidden ti-modal">
                                                                <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                                                    <div class="ti-modal-content">
                                                                        ...
                                                                        <form  action="{{route('PRINCIPAL.staff.payscale.update',[$staff->id,$payscale->id])}}" method="post">
                                                                            @csrf
                                                                            @method('patch')
                                                                            <div class="ti-modal-body">
                                                            ...
                                                            @if($payscale->pivot->status == 'active' && ($difference->y ==0 && $difference->m <= 1))
                                                                <div class="hs-tooltip ti-main-tooltip">
                                                                    <form action="{{ route('PRINCIPAL.staff.payscale.destroy',[$staff->id,$payscale->id]) }}" method="post">
                                            ...
                                            <tr class="{{$cons_teaching_pay->status =='inactive'?'bg-gray-200':''}}">
                                                ...
                                                <td>
                                                        ...
                                                        <div id="edit_cons_teaching_payscale{{$i}}" class="hs-overlay hidden ti-modal">
                                                            <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                                                <div class="ti-modal-content">
                                                                    ...
                                                                    <form  action="{{route('PRINCIPAL.staff.payscale.update',[$staff->id,$cons_teaching_pay->id])}}" method="post">
                                                                        @csrf
                                                                        @method('patch')
                                                                            <div class="ti-modal-body">
                                                                                @if($cons_teaching_pay->status == 'inactive')
                                                    ...
                                                    @if($cons_teaching_pay->status == 'active' && ($difference->y ==0 && $difference->m <= 1))
                                                        <div class="hs-tooltip ti-main-tooltip">
                                                            <form action="{{ route('PRINCIPAL.staff.payscale.destroy',[$staff->id,$cons_teaching_pay->id]) }}" method="post">
                                                ...
                                                <td>
                                                    @if($ntpays->pivot->end_date == null)
                                                        ...
                                                        <div id="edit_nonteaching_payscale{{$i}}" class="hs-overlay hidden ti-modal">
                                                            <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                                                <div class="ti-modal-content">
                                                                    ...
                                                                    <form  action="{{route('PRINCIPAL.staff.payscale.update',[$staff->id,$ntpays->id])}}" method="post">
                                                                        @csrf
                                                                        @method('patch')
                                                                        <div class="ti-modal-body">
                                                                            {{-- Pay Type Setting --}}
                                                        ...
                                                        @if($ntpays->pivot->status == 'active' && ($difference->y ==0 && $difference->m <= 1))
                                                            <div class="hs-tooltip ti-main-tooltip">
                                                                <form action="{{ route('PRINCIPAL.staff.payscale.destroy',[$staff->id,$ntpays->id]) }}" method="post">
                                                    ...
                                                    @if($ntcpays->pivot->end_date == null)
                                                        ...
                                                        <div id="edit_nonteachingconso_payscale{{$i}}" class="hs-overlay hidden ti-modal">
                                                            <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                                                <div class="ti-modal-content">
                                                                    ...
                                                                    <form  action="{{route('PRINCIPAL.staff.payscale.update',[$staff->id,$ntcpays->id])}}" method="post">
                                                                        @csrf
                                                                        @method('patch')
                                                                        <div class="ti-modal-body">
                                                        ...
                                                        <!--Edit modal for departments staff ends-->
                                                            ...
                                                            @if($ntcpays->pivot->status == 'active' && ($difference->y ==0 && $difference->m <= 1))
                                                                <div class="hs-tooltip ti-main-tooltip">
                                                                    <form action="{{ route('PRINCIPAL.staff.payscale.destroy',[$staff->id,$ntcpays->id]) }}" method="post">
                                                    ...
                                                    @if($fntp->end_date == null)
                                                            ...
                                                            <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                                                <div class="ti-modal-content">
                                                                    <div class="ti-modal-header">
                                                                     ...
                                                                     <form  action="{{route('PRINCIPAL.staff.payscale.update',[$staff->id,$fntp->id])}}" method="post">
                                                                        @csrf
                                                                        @method('patch')
                                                                        <div class="ti-modal-body">
                                                        ...
                                                        <!--Edit modal for departments staff ends-->
                                                            ...
                                                            @if($fntp->status == 'active' && ($difference->y ==0 && $difference->m <= 1))
                                                                <div class="hs-tooltip ti-main-tooltip">
                                                                    {{-- <form action="{{ route('PRINCIPAL.staff.ntfixedpay.destroy',[$staff->id,$fntp->id]) }}" method="post"> --}}
        ...
        <div id="add_additional_designation" class="hs-overlay hidden ti-modal">
            <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                <div class="ti-modal-content">
                    ...
                    <form  action="{{route('PRINCIPAL.staff.additional_designation.create',$staff->id)}}" method="post">
                        @csrf
                        <div class="ti-modal-body">
                            <div class="grid lg:grid-cols-2 gap-2 space-y-2 lg:space-y-0">
                                <div class="space-y-2">
                    ...
                    @foreach ($staff->designations as $add_designaions)
                        ...
                        <tr class="{{$add_designaions->pivot->status =='inactive'?'bg-gray-200':''}}">
                            ...
                            <td>
                                ...
                                <div id="edit_additional_designation{{$i}}" class="hs-overlay hidden ti-modal">
                                    <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                        <div class="ti-modal-content">
                                            ...
                                            <form  action="{{route('PRINCIPAL.staff.additional_designation.update',[$staff->id, $add_designaions->pivot->id])}}" method="post">
                                                @csrf
                                                @method('patch')
                                                <div class="ti-modal-body">
                                                    <div class="grid lg:grid-cols-2 gap-2 space-y-2 lg:space-y-0">
                                ...
                                <div class="hs-tooltip ti-main-tooltip">
                                    <form action="{{ route('PRINCIPAL.staff.additionaldesignation.destroy',[$staff->id,$add_designaions->pivot->id]) }}" method="post">
