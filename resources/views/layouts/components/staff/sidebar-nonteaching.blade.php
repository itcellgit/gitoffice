                ...
                <div class="main-sidebar " id="sidebar-scroll">
                    ...
                    <nav class="main-menu-container nav nav-pills flex-column sub-open">
                        ...
                        <ul class="main-menu">
                            ...
                            <li class="slide">
                                <a href="{{url('/Non-Teaching/ntqualification')}}" class="side-menu__item">
                            ...
                            <li class="slide">
                                <a href="{{url('Non-Teaching/ntleaves')}}" class="side-menu__item">
                            ...
                            <li class="slide  has-sub">
                                ...
                                <ul class="slide-menu child1">
                                    {{-- <li class="slide"><a href="{{url('/Staff/Non-Teaching/examsectionissues')}}" class="side-menu__item">Issues</a></li> --}}
                                    {{-- <li class="slide"><a href="{{url('/HOD/issuescategory')}}" class="side-menu__item">Issues Subcategory</a></li> --}}
                                    <li class="slide"><a href="{{url('/Staff/Non-Teaching/viewstudentissues')}}" class="side-menu__item">View Student Issues</a></li>
                                </ul>
                            </li>
