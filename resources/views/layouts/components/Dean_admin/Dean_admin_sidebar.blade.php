                ...
                <div class="main-sidebar " id="sidebar-scroll">
                    ...
                    <nav class="main-menu-container nav nav-pills flex-column sub-open">
                        ...
                        <ul class="main-menu">
                            ...
                            <!-- End::slide__category -->
                            <li class="slide">
                                <a href="{{url('/Dean_admin/dashboard')}}" class="side-menu__item">
                            ...
                            <li class="slide">
                                <a href="{{url('Dean_admin/staff/staffindex')}}" class="side-menu__item">
                            ...
                            <li class="slide  has-sub">
                                ...
                                <ul class="slide-menu child1">
                                    <li class="slide"><a href="{{url('/Dean_admin/leaves_management/daleaves')}}" class="side-menu__item">Leaves</a></li>

                                   <li class="slide"><a href="{{url('/Dean_admin/leaves_management/daleaves_entitlement')}}" class="side-menu__item">Enititlement</a></li>

                                    <li class="slide"><a href="{{url('/Dean_admin/leaves_management/daholiday_rh_list')}}" class="side-menu__item">Holiday And RH List</a></li>
                                    <li class="slide"><a href="{{url('/Dean_admin/leaves_management/daleaves_calender')}}" class="side-menu__item">Leaves Calender</a></li>
                                </ul>
                            </li>
                        </ul>
