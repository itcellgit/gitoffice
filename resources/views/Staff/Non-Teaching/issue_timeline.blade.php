    ...
    <!-- Page Header -->
        <div class="block justify-between page-header sm:flex">
            ...
            <ol class="flex items-center whitespace-nowrap min-w-0">
                <li class="text-sm">
                    <a class="flex items-center font-bold text-primary hover:text-primary dark:text-primary truncate" href="/Staff/Non-Teaching/viewstudentissues" style="color: red;">
                         Back
            ...
            <div class="box-header">
                <div class="flex">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="32" height="32"><path d="M22 21H2V19H3V4C3 3.44772 3.44772 3 4 3H18C18.5523 3 19 3.44772 19 4V9H21V19H22V21ZM17 19H19V11H13V19H15V13H17V19ZM17 9V5H5V19H11V9H17ZM7 11H9V13H7V11ZM7 15H9V17H7V15ZM7 7H9V9H7V7Z"></path></svg> 
                                            Issue Interaction Details of - <b style="color: red; font-size:18px">{{ $student_issue->usn }}</b>
                    </h5>
                            ...
                            <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                <div class="ti-modal-content">
                                    <div class="ti-modal-header">
                                        ...
                                        <form  action="{{route('Staff.Non-Teaching.issue_timeline.store',$student_issue->id)}}" method="post">
                                            @csrf
                                                            <div class="ti-modal-body">
                                                                <div class="grid lg:grid-cols-2 gap-2 space-y-2 lg:space-y-0">
                                                                    <div class="space-y-2">
                                                                        <label for="date_of_interaction" class="ti-form-label mb-0 font-bold">Date of Interaction:<span class="text-red-500">*</span></label>
                                                                ...
                                                                <div class="max-w-sm space-y-3 pb-6">
                                                                    <label for="" class="ti-form-label mb-0 font-bold">Interaction : </label>
                                                                    <input type="text" name="interaction" class="ti-form-input" required placeholder="Interaction">
                                                                </div>

                                                                <div class="grid lg:grid-cols-2 gap-2 space-y-2 lg:space-y-0">
                                                                    <div class="space-y-2">
                                                                        <label for="" class="ti-form-label mb-0 font-bold">Followup Date :<span class="text-red-500">*</span></label>
                                                                            <div class="flex shadow-sm max-w-sm space-y-3 pb-6">
                                                                                ...
                                                                                <input type="date" name="followup_date"
                                                                                    class="ti-form-input rounded-l-none focus:z-10 flatpickr-input date"
                                                                                    id="fdate" placeholder="Followup date" value="">
                                                                            </div>
                                                                    </div>
                                                                </div>

                                                                <div class="max-w-sm space-y-3 pb-6">
                                                                    <label for="status" class="ti-form-label mb-0 font-bold">Status:</label>
                                                                    <select name="status" id="status" class="ti-form-input" required>
                ...
                <div class="col-span-12">
                    ...
                    <div class="box-body">
                                    ...
                                    <div class="box-body p-4">
                                        {{-- @foreach($student_issues as $issue) --}}
                                            <h6 class="font-semibold text-base mb-2">
                                                ...
                                                @else
                                                    Other - {{ $student_issue->other_issue ?? '-' }}
                                                @endif
                                            </h6>
                                            <p class="text-xs text-gray-500 dark:text-white/70">{{ $student_issue->description }}</p>
                                            {{-- @else
                        ...
                        <div class="timeline">
                            ...
                            @endphp
                            <div class="timeline-main">
                            <div class="{{ $index % 2 == 0 ? 'timeline-right' : 'timeline-left' }}">
                            {{-- <div class="timeline-right"> --}}
                                <div class="timeline-body">
                                <div class="box">
                                    <div class="box-body p-4">
                                        <h6 class="font-semibold text-base mb-2">
                                            {{ $timeline->status ?? '' }} <br>{{ $timeline->followup_date ?? '' }}
                                        </h6>
                                        <p class="text-xs text-gray-500 dark:text-white/70">
