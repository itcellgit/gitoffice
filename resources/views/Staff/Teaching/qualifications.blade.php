                        ...
                        <div class="box border-0 shadow-none mb-0">
                            ...
                            <div class="box-body">
                                        ...
                                        <div class="ti-modal-content">
                                            <div class="ti-modal-header">
                                                <h3 class="ti-modal-title">
                                                    ...
                                                    Add Qualification Of <span class="text-red-400"> {{$staff[0]->fname.' '.$staff[0]->mname.' '.$staff[0]->lname}}</span>
                                                </h3>
                                            ...
                                            <form  action="{{route('Teaching.staff.qualification.store')}}" method="post">
                                            {{-- <form  action="{{route('Teaching.staff.qualification.store', $staff->first()->id)}}" method="post"> --}}
                                                @csrf
                                                <div class="ti-modal-body">
                                                    ...
                                                    <div class="grid lg:grid-cols-2 gap-1 space-y-2 lg:space-y-0">
                                                        <div class="max-w-sm space-y-3 pb-6 grade">
                                                            ...
                                                            <input type="text" name="grade" class="ti-form-input" value="" placeholder="Enter CGP Grade Number"/>
                                                        </div>
                                                    </div>
                                                </div>    
                                ...
                                <div class="table-bordered rounded-sm ti-custom-table-head overflow-auto table-auto">
                                    <table id="staff_qual" class="ti-custom-table ti-custom-table-head whitespace-nowrap">
                                        ...
                                        <tbody class="">
                                            @foreach($staff as $s)
                                                @forelse($s->qualifications as $qualification)
                                                    <tr>
                                                        <td><span>{{$i++}}</span></td>
                                                        ...
                                                        <td>
                                                            <span>
                                                                @isset($qualification->pivot->yop)
                                                                    {{ $qualification->pivot->yop }}
                                                                @else
                                                                    --NA--
                                                                @endisset
                                                            </span>
                                                        ...
                                                        <td>
                                                            <span>
                                                                @isset($qualification->pivot->grade)
                                                                    {{ $qualification->pivot->grade }}
                                                                @else
                                                                    --NA--
                                                                @endisset
                                                            </span>
                                                        ...
                                                        <td class="font-medium space-x-2 rtl:space-x-reverse">
                                                                    ...
                                                                    <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 md:mx-auto">
                                                                        <div class="ti-modal-content">
                                                                            <div class="ti-modal-header">
                                                                                <h3 class="ti-modal-title">
                                                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16"><path d="M16.7574 2.99666L14.7574 4.99666H5V18.9967H19V9.2393L21 7.2393V19.9967C21 20.5489 20.5523 20.9967 20 20.9967H4C3.44772 20.9967 3 20.5489 3 19.9967V3.99666C3 3.44438 3.44772 2.99666 4 2.99666H16.7574ZM20.4853 2.09717L21.8995 3.51138L12.7071 12.7038L11.2954 12.7062L11.2929 11.2896L20.4853 2.09717Z"></path></svg>
                                                                                    Edit Qualification Of<span class="text-red-400">{{$staff[0]->fname.' '.$staff[0]->mname.' '.$staff[0]->lname}}</span>
                                                                                </h3>
                                                                                <button type="button" class="hs-dropdown-toggle ti-modal-close-btn"
                                                                            ...
                                                                            <form action="{{ route('Teaching.staff.qualification.update', ['qualification' => $qualification->id]) }}" method="post">
                                                                                @csrf
                                                                                @method('patch')
                                                                                <div class="ti-modal-body">
                                                                                    <div class="grid lg:grid-cols-2 gap-1 space-y-2 lg:space-y-0">
                                                                                        ...
                                                                                        <div class="max-w-sm space-y-3 pb-6">
                                                                                            ...
                                                                                            <select class="ti-form-select status_type" name="status" id="status">
                                                                                                <option value="#">Choose One</option>
                                                                                                <option value="Persuing" {{($qualification->pivot->status=="Persuing"? "selected":"")}}>Persuing</option>
                                                                                    ...
                                                                                    <div class="grid lg:grid-cols-2 gap-1 space-y-2 lg:space-y-0">
                                                                                        <div class="max-w-sm space-y-3 pb-6 grade">
                                                                                            ...
                                                                                            <input type="text" name="grade" class="ti-form-input" value="{{$qualification->pivot->grade}}" placeholder="Enter CGP Grade Number"/>
                                                                                        </div> 
                                                                                    </div>
                                                                                </div>    
                                                                                <div class="ti-modal-footer">
                                                            ...
                                                            <div class="hs-tooltip ti-main-tooltip">
                                                                <form action="{{ route('Teaching.staff.qualification.destroy', ['qualification' => $qualification->id]) }}" method="post">
