                                ...
                                <div class="mt-3">
                                    <div id="profile-settings-1" role="tabpanel" aria-labelledby="profile-settings-item-1">
                                        <div class="box border-0 shadow-none mb-0">
                                            ...
                                            <div class="box-body">
                                                <div>
                                                    <form action="{{route('Staff.Teaching.update',$staff->id)}}" method="post" enctype="multipart/form-data">
                                                        @csrf
                                                        @method('patch')
                                                        ...
                                                        <div class="pt-6 ">
                                                            <button type="submit" class="ti-btn m-0 ti-btn-soft-primary text-right rounded-full">
