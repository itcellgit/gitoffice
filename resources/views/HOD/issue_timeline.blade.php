    ...
    <!-- Page Header -->
        <div class="block justify-between page-header sm:flex">
            ...
            <ol class="flex items-center whitespace-nowrap min-w-0">
                <li class="text-sm">
                    <a class="flex items-center font-bold text-primary hover:text-primary dark:text-primary truncate" href="/HOD/viewstudentissues" style="color: red;">
                         Back
                            ...
                            <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                <div class="ti-modal-content">
                                    <div class="ti-modal-header">
                                        ...
                                        <form  action="{{route('HOD.issue_timeline.store',$student_issue->id)}}" method="post">
                                            @csrf
