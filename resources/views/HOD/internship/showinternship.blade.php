    ...
    <div class="content">
        ...
        <div class="main-content">
                        ...
                        <table id="student_studentinternship_table"
                            ...
                            <thead class="bg-gray-50 dark:bg-black/20">
                                <tr class="">
                                    ...
                                    <th scope="col" class="dark:text-white/80">@sortablelink('id', 'project name')</th>
                                </tr>
                            </thead>
                            <tbody class="">
                                @php
                                        ...
                                        <tr class="">
                                            ...
                                            <td>
                                                {{-- <div class="hs-tooltip ti-main-tooltip">
                                                    ...
                                                    <form
                                                        action="{{ route('HOD.internship.student_studentinternship.destroy', [$studentinternship->id, $sstudent->pivot->id]) }}"
                                                        method="post">
            ...
            <div class="container mt-5">
                ...
                <a href="/HOD/internship/studentinternship"
