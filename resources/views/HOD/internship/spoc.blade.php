                                        ...
                                        <div id="hs-medium-modal" class="hs-overlay hidden ti-modal">
                                            <div
                                                ...
                                                <div class="ti-modal-content">
                                                    ...
                                                    <form action="{{ route('HOD.internship.spoc.store') }}" method="post">
                                                        @csrf
                                                    ...
                                                    <tr class="">
                                                        ...
                                                        <td class="font-medium space-x-2 rtl:space-x-reverse">
                                                            <div class="hs-tooltip ti-main-tooltip">
                                                                <a href="{{ route('HOD.internship.spoc.show', $spoc->id) }}"
                                                                ...
                                                                <div id="spocs_edit_modal{{ $counter }}"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="ti-modal-content">
                                                                            ...
                                                                            <form
                                                                                action="{{ route('HOD.internship.spoc.update', $spoc->id) }}"
                                                                                method="post">
                                                                                @csrf
                                                                                @method('patch')
                                                                                <div class="ti-modal-body">
                                                            ...
                                                            {{-- <div class="hs-tooltip ti-main-tooltip">
                                                                <form
                                                                    action="{{ route('HOD.internship.spoc.destroy', $spoc->id) }}"
                                                                    method="post">
