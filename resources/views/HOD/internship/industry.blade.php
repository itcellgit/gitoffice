                                            ...
                                            <div id="hs-medium-modal" class="hs-overlay hidden ti-modal">
                                                <div
                                                    ...
                                                    <div class="ti-modal-content">
                                                        ...
                                                        <form action="{{ route('HOD.internship.industry.store') }}"
                                                            method="post">
                                                            @csrf
                                                        ...
                                                        <tr class="">
                                                            ...
                                                            <td class="font-medium space-x-2 rtl:space-x-reverse">
                                                                {{-- <div class="hs-tooltip ti-main-tooltip">
                                                                    <a href="{{ route('HOD.internship.industry.show', $industry->id) }}"
                                                                    ...
                                                                    <div id="industries_edit_modal{{ $i }}"
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class="ti-modal-content">
                                                                                ...
                                                                                <form
                                                                                    action="{{ route('HOD.internship.industry.update', $industry->id) }}"
                                                                                    method="post">
                                                                                    @csrf
                                                                                    @method('patch')
                                                                                    <div class="ti-modal-body">
                                                                ...
                                                                {{-- <div class="hs-tooltip ti-main-tooltip">
                                                                    <form
                                                                        action="{{ route('HOD.internship.industry.destroy', $industry->id) }}"
                                                                        method="post">
