                                    ...
                                    <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                        <div class="ti-modal-content">
                                            <div class="ti-modal-header">
                                                ...
                                                <form  action="{{route('HOD.internship.studentinternship.student_studentinternship.store',$studentinternship)}}" method="post">
                                                    @csrf
                                ...
                                @foreach ($student_studentinternship as $sstudent)
                                    <tr class="">
                                        ...
                                        <td>
                                            ...
                                            <div class="hs-tooltip ti-main-tooltip">
                                                        <form action="{{ route('HOD.internship.student_studentinternship.destroy',[$sstudent->id]) }}" method="post">
