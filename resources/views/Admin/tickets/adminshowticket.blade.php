            ...
            <div class="box-body">
                <div class="flex">
                    ...
                    <div class="flex">
                        ...
                        Ticket Status:&nbsp;&nbsp;&nbsp;&nbsp;
                        <div class="hs-tooltip ti-main-tooltip mt-5 my-auto">
                            <a data-hs-overlay="#validate_status_modal"
                                class="hs-dropdown-toggle m-0 hs-tooltip-toggle relative w-8 h-8 ti-btn rounded-full p-0 transition-none focus:outline-none"
                            ...
                            <div id="validate_status_modal" class="hs-overlay hidden ti-modal">
                                <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 md:mx-auto">
                                    <div class="ti-modal-content">
                                        <div class="ti-modal-header">
                                            <h3 class="ti-modal-title">
                                            ...
                                            <button type="button" class="hs-dropdown-toggle ti-modal-close-btn"
                                                data-hs-overlay="#validate_status_modal">
                                                <span class="sr-only">Close</span>
                                                <svg class="w-3.5 h-3.5" width="8" height="8" viewBox="0 0 8 8" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                        ...
                                        <form id="ticketStatus" action="{{ route('ticket.reply.update', $ticket->id) }}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            @method('PATCH') 
                                            <div class="ti-modal-body">
                                                <div class="max-w-sm space-y-3 pb-6">
                                                ...
                                                <div class="ti-modal-footer">
                                                <button type="button" class="hs-dropdown-toggle ti-btn ti-border font-medium bg-white text-gray-700 shadow-sm align-middle hover:bg-gray-50 focus:ring-offset-white focus:ring-primary dark:bg-bgdark dark:hover:bg-black/20 dark:border-white/10 dark:text-white/70 dark:hover:text-white dark:focus:ring-offset-white/10" data-hs-overlay="#validate_status_modal">
                                                    Close
                                                </button>
                                                <input type="submit" id="updateStatusBtn" class="ti-btn bg-primary text-white hover:bg-primary focus:ring-primary dark:focus:ring-offset-white/10" value="Update"/>
                                            </div>
                                        </form>
                                     </div>
                                </div>
                ...
                <!--status modal start here -->
                {{-- <div class="hs-tooltip ti-main-tooltip mt-5 my-auto">
                    <button data-hs-overlay="#validate_status_modal"
                        class="hs-dropdown-toggle  m-0 hs-tooltip-toggle relative w-8 h-8 ti-btn rounded-full p-0 transition-none focus:outline-none ti-btn-soft-secondary">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16" fill="currentColor"><path d="M7.29117 20.8242L2 22L3.17581 16.7088C2.42544 15.3056 2 13.7025 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22C10.2975 22 8.6944 21.5746 7.29117 20.8242Z"></path></svg>
                        <span
                            class="hs-tooltip-content ti-main-tooltip-content py-1 px-2 bg-gray-900 text-xs font-medium text-white shadow-sm dark:bg-slate-700"
                            role="tooltip">
                           Status
                ...
                <!--status modal End here-->


                <div class="table-bordered rounded-sm ti-custom-table-head overflow-auto table-auto mt-5">
                    <table id="ticketing_table" class="ti-custom-table ti-custom-table-head whitespace-nowrap">
                        ...
                        <tbody class="">
                            ...
                            {{-- <td><span><img src="{{ asset('attachment/'.$ticket->attachment)}}"></span></td> --}}
                            <td>
                                <span>
                    ...
                    <table id="postticket_table" class="ti-custom-table ti-custom-table-head whitespace-nowrap">
                        ...
                        <tbody class="">
                            @foreach($postticket as $pt)
                                ...
                                {{-- <td><span><img src="{{ asset('Description/'.$pt->attachment)}}"></span></td> --}}
                                <td>
                                    <span>
