                                            ...
                                            <table id="Pticketing_table" class="ti-custom-table ti-custom-table-head whitespace-nowrap">
                                                ...
                                                @foreach($postticket as $pt)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="hs-tooltip ti-main-tooltip">
                                                                <button data-hs-overlay="#tickets_edit_modal"
                                                                    class="hs-dropdown-toggle  m-0 hs-tooltip-toggle relative w-8 h-8 ti-btn rounded-full p-0 transition-none focus:outline-none ti-btn-soft-secondary">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16"><path d="M16.7574 2.99666L14.7574 4.99666H5V18.9967H19V9.2393L21 7.2393V19.9967C21 20.5489 20.5523 20.9967 20 20.9967H4C3.44772 20.9967 3 20.5489 3 19.9967V3.99666C3 3.44438 3.44772 2.99666 4 2.99666H16.7574ZM20.4853 2.09717L21.8995 3.51138L12.7071 12.7038L11.2954 12.7062L11.2929 11.2896L20.4853 2.09717Z"></path></svg>
                                                                        <span
                                                                            class="hs-tooltip-content ti-main-tooltip-content py-1 px-2 bg-gray-900 text-xs font-medium text-white shadow-sm dark:bg-slate-700"
                                                                    ...
                                                                    <form  action="{{route('ticket.reply.update',$ticket->id)}}" method="post" enctype="multipart/form-data"> 
                                                                        ...
                                                                        <div class="ti-modal-body">
                                                                            <div class="max-w-sm space-y-3 pb-6">
                                                                                ...
                                                                                <input type="text" name="description" class="ti-form-input" required placeholder="description" value="{{$pt->description}}">
                                                                            </div>
                                                                            <div class="max-w-sm space-y-3 pb-6">
                                                                                <label for="" class="ti-form-label">attachment : </label>
                                                                                <input type="file" name="attachment" class="ti-form-input" required placeholder="attachment"  value="{{$pt->description}}">
