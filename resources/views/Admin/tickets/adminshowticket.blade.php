                 ...
                 <h5 class="my-auto box-title">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-building-church"
                            ...
                            <div class=" block ltr:ml-auto rtl:mr-auto my-auto">
                                <a href="#status_modal" id="validate_status_modal" onclick="showChangeStatusForm()">
                                    Ticket Status:&nbsp;&nbsp;
                                    <span style="@if($ticket->status =='Open') color: red; @elseif($ticket->status =='Pending') color: Orange; @elseif($ticket->status =='Resolved') color: green; @endif">{{$ticket->status}}</span>
                                </a>
                                <div id="status_modal" class="hs-overlay hidden ti-modal">
                                    <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out md:!max-w-2xl md:w-full m-3 md:mx-auto">
                                        <div class="ti-modal-content">
                                            <div class="ti-modal-header">
                                                ...
                                                <button type="button" class="hs-dropdown-toggle ti-modal-close-btn" data-hs-overlay="#status_modal">
...
<script>
    document.getElementById('updateStatusBtn').addEventListener('click', function() {
        ...
        .then(data => {
            ...
            if (status === 'Resolved') {
                document.getElementById('validate_status_modal').classList.add('disabled');
            }
