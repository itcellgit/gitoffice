                                                ...
                                                @forelse($tickets as $ticket)
                                                    ...
                                                    <tr class="">
                                                        ...
                                                        <td class="font-medium space-x-2 rtl:space-x-reverse">
                                                                ...
                                                                <div id="asso_edit_modal{{$i}}" class="hs-overlay hidden ti-modal">
                                                                    <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 md:mx-auto">
                                                                        <div class="ti-modal-content">
                                                                            ...
                                                                            <form  action="{{route('Admin.tickets.adminticket.update',$ticket->id)}}" method="post" enctype="multipart/form-data"> 
                                                                                @csrf
                                                                                @method('patch')
                                                                                <div class="ti-modal-body">
                                                                                    <div class="grid lg:grid-cols-2 gap-2 space-y-2 lg:space-y-0">
                                                            ...
                                                            <div class="hs-tooltip ti-main-tooltip"> 
                                                             <!--Add Route here to delete the data-->   
                                                            <form action="{{ route('Admin.tickets.adminticket.destroy',$ticket->id) }}" method="post" enctype="multipart/form-data">
