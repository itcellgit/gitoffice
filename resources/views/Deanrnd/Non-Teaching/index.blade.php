            ...
            $(document).ready(function () {
                ...
                // {{--  Function to handle the filter Date Range --}}
                    ...
                    $('#filterBtn').click(function () {
                        ...
                        var fromColumnIndex = $('#ntproattended th:contains("From_date")').index();
                        var toColumnIndex = $('#ntproattended th:contains("to_date")').index();

                        $('#ntproattended tbody tr').each(function () {
